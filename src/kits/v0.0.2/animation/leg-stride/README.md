# n:animation:leg-stride

Status: v0.0.2 architecture scaffold

## Purpose

Leg Stride kit for narrow execution kits for body and tool motion. It applies one narrow motion descriptor and never owns game rules.
