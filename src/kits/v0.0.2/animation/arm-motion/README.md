# n:animation:arm-motion

Status: v0.0.2 architecture scaffold

## Purpose

Arm Motion kit for narrow execution kits for body and tool motion. It applies one narrow motion descriptor and never owns game rules.
