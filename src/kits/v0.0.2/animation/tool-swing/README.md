# n:animation:tool-swing

Status: v0.0.2 architecture scaffold

## Purpose

Tool Swing kit for narrow execution kits for body and tool motion. It applies one narrow motion descriptor and never owns game rules.
