# Lobby Audio And Feedback Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Define lobby feedback cues that avoid humming and keep party state readable.
