# Landmark Silhouette Proof Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Require each major POI to have a readable silhouette from near, mid, and far distances.
