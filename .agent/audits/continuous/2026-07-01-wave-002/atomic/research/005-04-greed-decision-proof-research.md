...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Create human-view proof for the decision to mine more or leave.
