# Gold Greed Pressure Link Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Tie carried gold value and noise to pressure so greed changes risk.
