# Safe Route Vs Risk Route Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Differentiate safe long routes and risky short routes through authored map data.
