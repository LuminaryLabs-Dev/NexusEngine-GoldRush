# Loadout Ui Minimalism Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Keep equipment readable without turning the first screen into an inventory manager.
