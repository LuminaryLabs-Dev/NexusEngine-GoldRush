# Four Slot Party Contract Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Lock party lobby proof around up to four visible party slots and a clear leader state.
