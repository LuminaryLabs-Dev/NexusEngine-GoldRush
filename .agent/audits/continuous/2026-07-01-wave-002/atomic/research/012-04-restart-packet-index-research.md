...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Create one compact index that points to the latest roadmap, simulations, audits, and proof reports.
