# Replay Moment Taxonomy Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Define replay moment types for mining, threat, route, cashout, loss, score, and rescue.
