# Completion Audit Template Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Define requirement-by-requirement evidence needed before the active goal can ever be marked complete.
