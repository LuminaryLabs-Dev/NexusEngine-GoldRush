# Authored Cover Anchor Contract Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Move combat cover from player-relative fallback toward authored terrain anchors.
