# Group Type Dropdown Contract Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Keep Crew, Posse, and Outfit as a compact dropdown that affects launch payload without turning into hero cards.
