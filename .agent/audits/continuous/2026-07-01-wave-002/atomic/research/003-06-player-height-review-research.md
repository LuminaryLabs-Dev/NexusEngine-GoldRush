...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Judge map identity from the third-person player camera, not only top-down debug views.
