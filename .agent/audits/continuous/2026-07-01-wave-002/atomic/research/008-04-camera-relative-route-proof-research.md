# Camera Relative Route Proof Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Prove WASD follows camera look while traversing authored routes and slopes.
