# Decision Log Discipline Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Keep durable decisions in memory/lessons without duplicating stale claims.
