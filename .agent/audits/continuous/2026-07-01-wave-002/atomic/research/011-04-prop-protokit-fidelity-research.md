# Prop Protokit Fidelity Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Upgrade rocks, plants, towers, mines, rails, towns, and gold zones through object protokits.
