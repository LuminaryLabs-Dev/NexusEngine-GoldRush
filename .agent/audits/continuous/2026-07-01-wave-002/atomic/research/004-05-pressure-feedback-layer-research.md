# Pressure Feedback Layer Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Make pressure readable through world, audio, UI-minimal, and route cues.
