...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Separate cosmetic, tool, title, and progression rewards from run-local receipts.
