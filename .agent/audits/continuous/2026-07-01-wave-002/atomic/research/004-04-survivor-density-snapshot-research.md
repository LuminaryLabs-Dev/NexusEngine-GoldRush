# Survivor Density Snapshot Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Track player or bot density per phase so convergence can be tuned.
