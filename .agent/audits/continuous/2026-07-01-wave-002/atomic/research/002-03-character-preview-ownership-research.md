# Character Preview Ownership Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Make the 3D lobby character preview a render consumer with its own drag-spin proof.
