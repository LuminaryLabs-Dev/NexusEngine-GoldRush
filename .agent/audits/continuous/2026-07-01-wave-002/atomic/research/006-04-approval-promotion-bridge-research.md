# Approval Promotion Bridge Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Keep actual audio behind approval while preserving cue slots.
