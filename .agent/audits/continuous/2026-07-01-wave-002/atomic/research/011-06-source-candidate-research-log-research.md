# Source Candidate Research Log Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Track free online models/audio as candidates only until approval.
