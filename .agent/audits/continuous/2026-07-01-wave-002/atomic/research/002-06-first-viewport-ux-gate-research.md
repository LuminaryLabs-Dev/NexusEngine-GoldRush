# First Viewport Ux Gate Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Ensure only hero controls appear first-screen while advanced/debug controls stay folded.
