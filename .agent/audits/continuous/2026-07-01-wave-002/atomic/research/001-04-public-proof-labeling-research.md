# Public Proof Labeling Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Make public proof reports label local, public, simulated, live, and peer-tested participants separately.
