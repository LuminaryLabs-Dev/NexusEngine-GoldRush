...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Make bots traverse authored routes and interact with mining/extraction systems.
