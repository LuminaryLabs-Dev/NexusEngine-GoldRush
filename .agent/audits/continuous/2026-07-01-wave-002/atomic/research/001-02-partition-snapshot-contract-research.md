# Partition Snapshot Contract Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Require every room partition to expose a stable sanitized snapshot for staged scale proof.
