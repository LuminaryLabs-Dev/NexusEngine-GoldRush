...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Track browser performance and state size while staged participant count rises.
