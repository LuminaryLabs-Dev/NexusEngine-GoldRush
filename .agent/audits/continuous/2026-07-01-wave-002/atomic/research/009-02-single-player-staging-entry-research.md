# Single Player Staging Entry Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Add a proof-only single-player staging mode that does not leak into normal player UX.
