# Route Language Contract Research
...
What evidence, game reference, or engine surface is needed before GoldRush can implement: Define roads, rails, washes, ridges, and mine paths as authored navigation language.
