# Market Player AAA Gap Coverage Public Deploy Proof
...
Owner: agent-it research packets plus reference parity waves
...
- research/019-06-market-player-aaa-gap-coverage-public-deploy-proof-research.md
