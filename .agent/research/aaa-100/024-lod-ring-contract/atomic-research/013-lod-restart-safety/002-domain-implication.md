# 024.013 Lod Restart Safety - Domain Implication

Status: research-planned
Parent: 024 LOD ring contract
Atomic: 024.013 Lod Restart Safety
Domain: world/render
Owning kit candidate: `n:render:terrain-lod-rings`

## Domain Implication

Require LOD caches to rebuild on map revision change and never reuse stale geometry.
