...
## Question
What has to be researched, specified, and proven so equipment/tools can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Atomic Substeps
- Pickaxe, pan, revolver, rifle, lantern, satchel
- kit contracts
