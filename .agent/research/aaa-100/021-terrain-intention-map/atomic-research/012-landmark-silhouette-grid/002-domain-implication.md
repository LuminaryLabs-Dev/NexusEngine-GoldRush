# 021.012 Landmark Silhouette Grid - Domain Implication

Status: research-planned
Parent: 021 Terrain intention map
Atomic: 021.012 Landmark Silhouette Grid
Domain: world
Owning kit candidate: `n:goldrush:authored-desert-map`

## Domain Implication

Assign silhouettes players can recognize from ground level: mesa, mine headframe, water tower, town roofline, rail bridge, and depot beacon.
