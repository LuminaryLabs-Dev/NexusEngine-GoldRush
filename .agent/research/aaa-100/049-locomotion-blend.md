...
## Question
What has to be researched, specified, and proven so locomotion blend can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Domain Owner
`animation/control` owns this packet until implementation splits it into more specific kit or feature packets.
...
Movement stops sliding visually
