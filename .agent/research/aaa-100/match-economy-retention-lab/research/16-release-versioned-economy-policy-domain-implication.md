# Release Versioned Economy Policy - Domain Implication
...
- Owning domain: release/governance/economy.
- Generic candidate: n:release:economy-version.
- GoldRush custom kit: n:goldrush:economy-release-policy.
