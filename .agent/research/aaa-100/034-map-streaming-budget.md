...
## Question
What has to be researched, specified, and proven so map streaming budget can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Domain Owner
`performance` owns this packet until implementation splits it into more specific kit or feature packets.

## Kit Impact
n:goldrush:authored-desert-map plus terrain, collider, placement, route, and extraction-site kits

## Atomic Substeps
- Define active chunks
- define object budgets
- define memory targets
