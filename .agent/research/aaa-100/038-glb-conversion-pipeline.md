...
## Question
What has to be researched, specified, and proven so glb conversion pipeline can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
Models enter as usable game assets
