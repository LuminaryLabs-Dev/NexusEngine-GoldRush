...
## Question
What has to be researched, specified, and proven so adr and decision log can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
- record physics choice
- record asset boundary
