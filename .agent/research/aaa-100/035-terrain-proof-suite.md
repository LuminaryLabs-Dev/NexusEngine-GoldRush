...
## Question
What has to be researched, specified, and proven so terrain proof suite can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
Terrain work cannot regress silently
