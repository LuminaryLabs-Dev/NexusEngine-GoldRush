# Input Command Buffer Source Research
...
Buffer and sequence movement, interact, aim, fire, cover, and cashout commands before authority resolution. The source implication is that this system must become a named network kit surface with data, events, snapshot, reset, validator, and proof labels.
