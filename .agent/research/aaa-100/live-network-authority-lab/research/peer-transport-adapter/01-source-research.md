# Peer Transport Adapter Source Research
...
Wrap PeerJS/WebRTC connection events behind a stable NexusRealtime-style transport contract. The source implication is that this system must become a named network kit surface with data, events, snapshot, reset, validator, and proof labels.
