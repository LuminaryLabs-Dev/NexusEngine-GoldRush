# Fairness Sanity Abuse Boundary Source Research
...
Reject impossible commands and define what client-side authority is never allowed to decide. The source implication is that this system must become a named network kit surface with data, events, snapshot, reset, validator, and proof labels.
