# Signaling And ICE Readiness Source Research
...
Track signaling, ICE server configuration, connection candidate flow, and failure labels. The source implication is that this system must become a named network kit surface with data, events, snapshot, reset, validator, and proof labels.
