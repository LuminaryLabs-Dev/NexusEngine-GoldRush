# Network Mode Policy Source Research
...
Separate local, public proof, bot staging, simulated scale, peer party, and future live 60-player modes. The source implication is that this system must become a named network kit surface with data, events, snapshot, reset, validator, and proof labels.
