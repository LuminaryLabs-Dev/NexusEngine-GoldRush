# Delta Compression And Priority Source Research
...
Prioritize critical receipts over low-value movement/detail updates and keep messages under size budgets. The source implication is that this system must become a named network kit surface with data, events, snapshot, reset, validator, and proof labels.
