# Authoritative Receipt Ledger Source Research
...
Order irreversible gameplay facts such as mined gold, damage, cargo loss, cashout, score, and results. The source implication is that this system must become a named network kit surface with data, events, snapshot, reset, validator, and proof labels.
