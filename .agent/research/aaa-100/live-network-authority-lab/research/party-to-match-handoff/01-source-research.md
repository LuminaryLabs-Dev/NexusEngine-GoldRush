# Party To Match Handoff Source Research
...
Move a four-player party lobby into a larger match contract without mixing party transport with match authority. The source implication is that this system must become a named network kit surface with data, events, snapshot, reset, validator, and proof labels.
