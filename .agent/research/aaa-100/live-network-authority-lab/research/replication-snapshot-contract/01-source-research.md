# Replication Snapshot Contract Source Research
...
Define stable snapshot and delta shapes for player, bot, world, cargo, combat, and match state. The source implication is that this system must become a named network kit surface with data, events, snapshot, reset, validator, and proof labels.
