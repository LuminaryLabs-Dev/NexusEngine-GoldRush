# Prediction Reconciliation Source Research
...
Predict local movement and reconcile to authoritative snapshots without camera or player pulsing. The source implication is that this system must become a named network kit surface with data, events, snapshot, reset, validator, and proof labels.
