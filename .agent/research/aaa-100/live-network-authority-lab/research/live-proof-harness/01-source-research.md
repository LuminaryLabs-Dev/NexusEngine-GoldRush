# Live Proof Harness Source Research
...
Define how to prove real multi-browser, multi-peer, and eventually multi-machine matches. The source implication is that this system must become a named network kit surface with data, events, snapshot, reset, validator, and proof labels.
