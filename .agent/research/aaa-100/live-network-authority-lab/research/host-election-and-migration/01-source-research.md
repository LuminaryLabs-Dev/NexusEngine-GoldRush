# Host Election And Migration Source Research
...
Plan leader/host selection and recovery when the active match host disconnects. The source implication is that this system must become a named network kit surface with data, events, snapshot, reset, validator, and proof labels.
