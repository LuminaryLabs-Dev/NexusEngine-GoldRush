# Latency Jitter Loss Simulator Source Research
...
Simulate delay, jitter, packet loss, reordering, and disconnects before live testing. The source implication is that this system must become a named network kit surface with data, events, snapshot, reset, validator, and proof labels.
