# Authoritative Receipt Ledger Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:authoritative-receipt-ledger`
- `genericCandidate`: `n:network:receipt-ledger`
- `purpose`: Order irreversible gameplay facts such as mined gold, damage, cargo loss, cashout, score, and results.
