# Input Command Buffer Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:input-command-buffer`
- `genericCandidate`: `n:network:input-buffer`
- `purpose`: Buffer and sequence movement, interact, aim, fire, cover, and cashout commands before authority resolution.
