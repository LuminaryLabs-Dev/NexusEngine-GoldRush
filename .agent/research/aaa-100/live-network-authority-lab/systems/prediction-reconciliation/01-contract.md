...
- `domainPath`: `n:goldrush:prediction-reconciliation`
- `genericCandidate`: `n:network:prediction-reconciliation`
- `purpose`: Predict local movement and reconcile to authoritative snapshots without camera or player pulsing.
