# Partition Handoff And Cross Room Events Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:partition-handoff-events`
- `genericCandidate`: `n:network:partition-handoff`
- `purpose`: Move entities and event summaries across internal room partitions without duplicating authority.
