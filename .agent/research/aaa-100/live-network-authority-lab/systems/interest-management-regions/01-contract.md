# Interest Management Regions Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:interest-management-regions`
- `genericCandidate`: `n:network:interest-management`
- `purpose`: Limit replicated state by region, sightline, party, threat, and objective relevance.
