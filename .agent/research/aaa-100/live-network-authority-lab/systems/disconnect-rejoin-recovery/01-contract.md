# Disconnect Rejoin Recovery Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:disconnect-rejoin-recovery`
- `genericCandidate`: `n:network:reconnect-recovery`
- `purpose`: Define what happens when party members, live players, or authority peers leave and return.
