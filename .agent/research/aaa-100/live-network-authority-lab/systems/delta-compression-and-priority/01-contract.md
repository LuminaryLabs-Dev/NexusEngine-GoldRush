# Delta Compression And Priority Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:delta-compression-priority`
- `genericCandidate`: `n:network:delta-priority`
- `purpose`: Prioritize critical receipts over low-value movement/detail updates and keep messages under size budgets.
