# Live Room Authority Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:live-room-authority`
- `genericCandidate`: `n:network:room-authority`
- `purpose`: Define which peer or service owns match decisions, receipts, conflict resolution, and state publication.
