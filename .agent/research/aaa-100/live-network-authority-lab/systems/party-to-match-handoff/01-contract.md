# Party To Match Handoff Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:party-to-match-handoff`
- `genericCandidate`: `n:network:party-match-handoff`
- `purpose`: Move a four-player party lobby into a larger match contract without mixing party transport with match authority.
