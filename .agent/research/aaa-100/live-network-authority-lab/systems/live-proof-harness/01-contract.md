# Live Proof Harness Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:live-proof-harness`
- `genericCandidate`: `n:network:live-proof`
- `purpose`: Define how to prove real multi-browser, multi-peer, and eventually multi-machine matches.
