# Host Election And Migration Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:host-election-migration`
- `genericCandidate`: `n:network:host-election`
- `purpose`: Plan leader/host selection and recovery when the active match host disconnects.
