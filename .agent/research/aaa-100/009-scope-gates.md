...
## Question
What has to be researched, specified, and proven so scope gates can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
Large changes pause at named gates
