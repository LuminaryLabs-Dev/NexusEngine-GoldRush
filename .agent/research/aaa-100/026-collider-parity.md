...
## Question
What has to be researched, specified, and proven so collider parity can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Domain Owner
`physics` owns this packet until implementation splits it into more specific kit or feature packets.

## Kit Impact
n:goldrush:authored-desert-map plus terrain, collider, placement, route, and extraction-site kits

## Atomic Substeps
- Build collider from height source
- sample raycasts
- compare visible ground
...
- Folder: .agent/research/aaa-100/026-collider-parity/
- Index: .agent/research/aaa-100/026-collider-parity/README.md
