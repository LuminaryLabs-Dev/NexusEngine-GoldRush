...
## Question
What has to be researched, specified, and proven so combat camera complete can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Domain Owner
`control/camera` owns this packet until implementation splits it into more specific kit or feature packets.
...
Combat perspective is stateful
