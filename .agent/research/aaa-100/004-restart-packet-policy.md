...
## Question
What has to be researched, specified, and proven so restart packet policy can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Atomic Substeps
- Create restart template
- capture learned facts
- link proof artifacts
...
New agent can resume without chat memory
