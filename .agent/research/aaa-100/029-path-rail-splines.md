...
## Question
What has to be researched, specified, and proven so path and rail splines can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
- Author rail path
- author trails
- mark train stops and crossings
