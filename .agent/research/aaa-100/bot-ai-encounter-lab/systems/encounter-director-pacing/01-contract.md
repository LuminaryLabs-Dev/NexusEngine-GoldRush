# Encounter Director Pacing Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:encounter-director`
- `genericCandidate`: `n:ai:encounter-director`
- `purpose`: Schedule tension, quiet windows, ambushes, and extraction pressure from match state.
