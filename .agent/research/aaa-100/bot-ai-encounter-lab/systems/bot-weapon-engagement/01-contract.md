# Bot Weapon Engagement Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:bot-western-combat`
- `genericCandidate`: `n:ai:combat-agent`
- `purpose`: Define staged weapon engagement with aim, miss, hit, reload, and disengage timings.
