# Bot Cover And Peek Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:bot-cover-counterplay`
- `genericCandidate`: `n:ai:combat-agent`
- `purpose`: Make bots use cover, peek windows, and retreat routes tied to authored cover descriptors.
