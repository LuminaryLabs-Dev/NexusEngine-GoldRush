# Bot Difficulty Personas Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:bot-difficulty-personas`
- `genericCandidate`: `n:ai:difficulty-persona`
- `purpose`: Define difficulty behaviors that change timing and decisions, not only damage.
