# Bot Terrain Movement Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:bot-terrain-movement`
- `genericCandidate`: `n:ai:movement-agent`
- `purpose`: Move bots over the same terrain/raycast/collider rules used by the local player.
