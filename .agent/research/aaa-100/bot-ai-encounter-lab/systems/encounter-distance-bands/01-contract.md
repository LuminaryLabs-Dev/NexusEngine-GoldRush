# Encounter Distance Bands Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:encounter-distance-bands`
- `genericCandidate`: `n:ai:encounter-director`
- `purpose`: Control encounter distances so threats are readable at frontier scale.
