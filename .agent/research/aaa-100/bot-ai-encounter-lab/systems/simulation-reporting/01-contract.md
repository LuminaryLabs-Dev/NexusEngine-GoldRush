# Simulation Reporting Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:bot-simulation-reporting`
- `genericCandidate`: `n:runtime:simulation-proof`
- `purpose`: Write sanitized reports that label bot, simulated, local, public, and live proof boundaries.
