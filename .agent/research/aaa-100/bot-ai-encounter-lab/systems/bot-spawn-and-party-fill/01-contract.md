# Bot Spawn And Party Fill Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:bot-party-fill`
- `genericCandidate`: `n:ai:spawn-fill`
- `purpose`: Fill non-human slots and place bots into fair spawn bands without joining the player party.
