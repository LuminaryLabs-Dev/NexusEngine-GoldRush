# Bot Cashout Objective Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:bot-cashout-runner`
- `genericCandidate`: `n:ai:objective-agent`
- `purpose`: Make bots attempt extraction so cashout sites become contested objectives.
