# Bot Downed Revive Recovery Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:bot-recovery`
- `genericCandidate`: `n:ai:recovery-agent`
- `purpose`: Handle bot downed, revive, flee, and recovery states without blocking solo staging.
