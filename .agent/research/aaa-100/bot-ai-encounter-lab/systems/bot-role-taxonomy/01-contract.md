# Bot Role Taxonomy Contract

Status: planned

## Domain Contract

- `domainPath`: `n:goldrush:bot-role-taxonomy`
- `genericCandidate`: `n:ai:role-taxonomy`
- `purpose`: Define readable bot roles so staging pressure resembles a match instead of random moving targets.
