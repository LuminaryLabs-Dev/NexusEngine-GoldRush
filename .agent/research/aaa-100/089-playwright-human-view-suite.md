# 089 Playwright human-view suite
...
## Question
What has to be researched, specified, and proven so playwright human-view suite can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Atomic Substeps
- Screenshot title/lobby/train/run/combat/extract/results
- video motion only
