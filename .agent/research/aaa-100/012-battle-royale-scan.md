...
## Question
What has to be researched, specified, and proven so battle royale scan can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Domain Owner
`research` owns this packet until implementation splits it into more specific kit or feature packets.

## Kit Impact
research packets and future kit gap definitions

## Atomic Substeps
- Compare PUBG, Apex, Fortnite
- extract scale/traversal/mode needs
...
GoldRush BR needs are explicit
