...
## Question
What has to be researched, specified, and proven so performance budgets can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
AAA direction remains browser-feasible
