...
## Question
What has to be researched, specified, and proven so game-engine feature scan can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Atomic Substeps
- Extract scene/loading/render/physics/tooling ideas
- reject engine-scope extras
...
Missing production surfaces are named
