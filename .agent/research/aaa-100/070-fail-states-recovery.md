...
## Question
What has to be researched, specified, and proven so fail states/recovery can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Atomic Substeps
- Handle death, drop, disconnect, timeout, stuck, no gold
