...
## Question
What has to be researched, specified, and proven so proof taxonomy can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Atomic Substeps
- Split local, public, simulator, video, screenshot, unit-style validators
...
Proof type matches feature risk
