...
## Question
What has to be researched, specified, and proven so inventory items can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Atomic Substeps
- Define tools, ammo, tonics, dynamite, map clues
