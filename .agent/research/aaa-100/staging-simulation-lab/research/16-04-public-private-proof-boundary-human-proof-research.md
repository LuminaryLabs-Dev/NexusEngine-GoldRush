# Public Private Proof Boundary - Human Proof Research

Status: planned docs-only
Related packet: ../scenarios/16-04-public-private-proof-boundary-human-proof.md
...
The owner kit is `n:goldrush:public-private-proof-boundary`. It should expose a small public API, use private helpers for setup and measurement, emit `proof.boundary.classified`, and expose `publicPrivateProofBoundary` for validation.
...
Use `validate-public-private-proof-boundary` as the first validator seed. Negative fixtures must fail the fakeout: Local proof is cited as public proof or simulator proof is cited as live multiplayer proof.
