# Economy Reward Rehearsal - Human Proof Research

Status: planned docs-only
Related packet: ../scenarios/15-04-economy-reward-rehearsal-human-proof.md
...
The owner kit is `n:goldrush:economy-reward-rehearsal`. It should expose a small public API, use private helpers for setup and measurement, emit `economy.rehearsal.receipt.applied`, and expose `economyRewardRehearsal` for validation.
...
Use `validate-economy-reward-rehearsal` as the first validator seed. Negative fixtures must fail the fakeout: Results show a score but the score does not derive from mined, carried, contested, and extracted receipts.
