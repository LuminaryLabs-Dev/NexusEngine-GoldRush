# Training Yard Onboarding - Human Proof

Status: planned docs-only
Scenario: 03 Training Yard Onboarding
Domain: UX/staging
Owner kit: n:goldrush:training-yard-onboarding
...
Provide a safe practice space for movement, camera, mining, carrying, cover, and extraction before full pressure.

## Atomic Substeps

1. Confirm the scenario owner is `n:goldrush:training-yard-onboarding`.
...
- Event: `training.objective.completed`
- Snapshot: `trainingYardOnboarding`
...
`validate-training-yard-onboarding`

## Human Proof Seed

Player completes small in-world objectives with no debug overlay dependency and no forced state jumps.

## Fakeout To Prevent

Tutorial text exists but the player never performs the actual controls in-world.
