# 053 Controller/accessibility input
...
## Question
What has to be researched, specified, and proven so controller/accessibility input can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Domain Owner
`control/accessibility` owns this packet until implementation splits it into more specific kit or feature packets.
...
Core loop does not depend on one input style
