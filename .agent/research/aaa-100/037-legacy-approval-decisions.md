...
## Question
What has to be researched, specified, and proven so legacy approval decisions can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Domain Owner
`content/legal` owns this packet until implementation splits it into more specific kit or feature packets.
...
- block runtime promotion until approved
...
No raw/sanitized leak to runtime
