...
## Question
What has to be researched, specified, and proven so asset source catalog can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Atomic Substeps
- List legacy, free, procedural, generated asset sources
