# Toon Adaptation - Validator Research

Status: planned docs-only
Related gate: ../gates/06-03-toon-adaptation-validator.md
...
The phase belongs to `art/render` and should stay separate from renderer-only logic. Renderer code may consume approved snapshots, but it must not invent license, provenance, approval, placement, or gameplay meaning.
