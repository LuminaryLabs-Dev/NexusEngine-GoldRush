# Terrain Placement - Policy Research

Status: planned docs-only
Related gate: ../gates/10-01-terrain-placement-policy.md
...
The phase belongs to `world/placement` and should stay separate from renderer-only logic. Renderer code may consume approved snapshots, but it must not invent license, provenance, approval, placement, or gameplay meaning.
