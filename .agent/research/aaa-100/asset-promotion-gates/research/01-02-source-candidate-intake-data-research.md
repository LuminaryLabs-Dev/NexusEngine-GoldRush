# Source Candidate Intake - Data Contract Research

Status: planned docs-only
Related gate: ../gates/01-02-source-candidate-intake-data.md

## Research Lens

Apex mode guidance highlights separate competitive and lower-pressure modes, quicker variants, simplified rules in fast modes, and training/bot spaces as product surfaces GoldRush should plan for.

## Domain Implication

The phase belongs to `content/source` and should stay separate from renderer-only logic. Renderer code may consume approved snapshots, but it must not invent license, provenance, approval, placement, or gameplay meaning.
