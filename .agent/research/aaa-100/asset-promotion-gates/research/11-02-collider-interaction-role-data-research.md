# Collider Interaction Role - Data Contract Research

Status: planned docs-only
Related gate: ../gates/11-02-collider-interaction-role-data.md

## Research Lens

Hunt extraction references reinforce contested extraction, bounty/cargo visibility, timed extraction, team state constraints, and loss/reward pressure as extraction architecture checks.
