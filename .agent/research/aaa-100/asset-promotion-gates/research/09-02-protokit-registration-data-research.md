# Protokit Registration - Data Contract Research

Status: planned docs-only
Related gate: ../gates/09-02-protokit-registration-data.md
...
The phase belongs to `content/kits` and should stay separate from renderer-only logic. Renderer code may consume approved snapshots, but it must not invent license, provenance, approval, placement, or gameplay meaning.
