# Scale Pivot Origin - Human Proof Research

Status: planned docs-only
Related gate: ../gates/07-04-scale-pivot-origin-human-proof.md
...
The phase belongs to `world/content` and should stay separate from renderer-only logic. Renderer code may consume approved snapshots, but it must not invent license, provenance, approval, placement, or gameplay meaning.
