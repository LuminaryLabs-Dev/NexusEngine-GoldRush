# Provenance Evidence - Human Proof Research

Status: planned docs-only
Related gate: ../gates/03-04-provenance-evidence-human-proof.md
...
The phase belongs to `content/provenance` and should stay separate from renderer-only logic. Renderer code may consume approved snapshots, but it must not invent license, provenance, approval, placement, or gameplay meaning.
