# License Evidence - Policy Research

Status: planned docs-only
Related gate: ../gates/02-01-license-evidence-policy.md
...
The phase belongs to `content/legal` and should stay separate from renderer-only logic. Renderer code may consume approved snapshots, but it must not invent license, provenance, approval, placement, or gameplay meaning.
