# Browser Public Proof - Validator Research

Status: planned docs-only
Related gate: ../gates/14-03-browser-public-proof-validator.md
...
The phase belongs to `validation/proof` and should stay separate from renderer-only logic. Renderer code may consume approved snapshots, but it must not invent license, provenance, approval, placement, or gameplay meaning.
