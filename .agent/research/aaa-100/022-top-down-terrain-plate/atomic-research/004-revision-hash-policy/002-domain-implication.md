# 022.004 Revision Hash Policy - Domain Implication

Status: research-planned
Parent: 022 Top-down terrain plate
Atomic: 022.004 Revision Hash Policy
Domain: world
Owning kit candidate: `n:goldrush:terrain-source-plate`

## Domain Implication

Require source plate hashes and revision ids so screenshots and proofs can name the exact terrain source.
