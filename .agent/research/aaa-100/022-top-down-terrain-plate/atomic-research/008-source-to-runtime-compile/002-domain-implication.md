# 022.008 Source To Runtime Compile - Domain Implication

Status: research-planned
Parent: 022 Top-down terrain plate
Atomic: 022.008 Source To Runtime Compile
Domain: world
Owning kit candidate: `n:goldrush:terrain-source-plate`

## Domain Implication

Define the compile step that turns drawn source layers into runtime JSON, geometry buffers, and debug proof data.
