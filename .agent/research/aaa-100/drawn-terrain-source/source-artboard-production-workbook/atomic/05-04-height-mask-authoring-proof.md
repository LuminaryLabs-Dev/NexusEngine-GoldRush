# Height Mask Authoring Proof

Status: active docs-only
Atom: 05-04
Family: height-mask-authoring
Layer: proof
...
This atom exists to define validator, simulator, browser, and human-view proof needed before resolution.
