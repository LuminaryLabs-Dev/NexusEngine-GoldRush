# 003 - Resource Node Id Contract Research
...
Document the source signals and design implications for `resourceNodeIds` before future implementation.
...
What exact consumer echo proves `resourceNodeIds` is source-owned and not inferred from a primitive, helper, or renderer-only object?
