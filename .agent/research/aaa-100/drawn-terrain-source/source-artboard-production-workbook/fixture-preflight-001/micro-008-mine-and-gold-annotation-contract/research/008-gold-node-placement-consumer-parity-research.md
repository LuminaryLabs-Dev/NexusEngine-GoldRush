# 008 - Gold Node Placement Consumer Parity Research
...
Document the source signals and design implications for `goldNodePlacementEcho` before future implementation.
...
What exact consumer echo proves `goldNodePlacementEcho` is source-owned and not inferred from a primitive, helper, or renderer-only object?
