# 012 - Mine Gold Stale Proof Research
...
Document the source signals and design implications for `mineGoldRevisionPolicy` before future implementation.
...
What exact consumer echo proves `mineGoldRevisionPolicy` is source-owned and not inferred from a primitive, helper, or renderer-only object?
