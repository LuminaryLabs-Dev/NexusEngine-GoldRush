...
Document the source signals and design implications for `mineSites` before future implementation.
...
What exact consumer echo proves `mineSites` is source-owned and not inferred from a primitive, helper, or renderer-only object?
