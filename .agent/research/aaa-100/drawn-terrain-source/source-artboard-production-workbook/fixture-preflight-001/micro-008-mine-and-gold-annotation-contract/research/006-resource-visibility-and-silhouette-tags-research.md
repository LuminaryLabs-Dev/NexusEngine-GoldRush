# 006 - Resource Visibility And Silhouette Tags Research
...
Document the source signals and design implications for `resourceReadabilityTags` before future implementation.
...
What exact consumer echo proves `resourceReadabilityTags` is source-owned and not inferred from a primitive, helper, or renderer-only object?
