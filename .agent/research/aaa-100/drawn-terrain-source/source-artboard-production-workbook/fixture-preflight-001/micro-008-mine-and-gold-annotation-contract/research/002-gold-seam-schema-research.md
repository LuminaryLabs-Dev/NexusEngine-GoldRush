...
Document the source signals and design implications for `goldSeams` before future implementation.
...
What exact consumer echo proves `goldSeams` is source-owned and not inferred from a primitive, helper, or renderer-only object?
