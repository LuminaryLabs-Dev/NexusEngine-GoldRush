...
Make `goldYieldTierTags` small enough for a future implementation pass.

## Source Field

- Required field: `goldYieldTierTags`.
...
- Fail when `goldYieldTierTags` is missing, duplicated, contradictory, unversioned, non-source-owned, renderer-inferred, or silently replaced by a consumer.
