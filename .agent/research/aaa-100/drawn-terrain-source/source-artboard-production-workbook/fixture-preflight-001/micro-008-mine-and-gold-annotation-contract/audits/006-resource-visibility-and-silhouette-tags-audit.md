# 006 - Resource Visibility And Silhouette Tags Audit
...
Audit `resourceReadabilityTags` as a source-owned terrain annotation, not as a visual marker or gameplay shortcut.
...
- Add a validator case for `resourceReadabilityTags`.
