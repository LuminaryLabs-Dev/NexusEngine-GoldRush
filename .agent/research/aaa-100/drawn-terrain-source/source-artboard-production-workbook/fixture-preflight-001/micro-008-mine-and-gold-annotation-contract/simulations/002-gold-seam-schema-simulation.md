# 002 - Gold Seam Schema Simulation

Status: planned docs-only
Parent atom: `008-mine-and-gold-annotation-contract`
Source field: `goldSeams`

## Simulated Implementation

1. Add `goldSeams` to the tiny source fixture.
...
- Keep `goldSeams` as a source-data concern only.
...
Future implementation is acceptable only if validator proves at least one source-owned gold seam with id, shape, depth class, visibility class, yield class, and revision and the stop condition cannot pass through helper-only or renderer-only state.
