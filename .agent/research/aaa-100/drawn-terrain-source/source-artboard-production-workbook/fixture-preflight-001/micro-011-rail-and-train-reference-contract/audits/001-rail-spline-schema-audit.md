...
Audit `railSplines` as source-owned rail and train route data, not as a train mesh, cinematic shortcut, timer, or renderer helper.
...
- Add a validator case for `railSplines`.
