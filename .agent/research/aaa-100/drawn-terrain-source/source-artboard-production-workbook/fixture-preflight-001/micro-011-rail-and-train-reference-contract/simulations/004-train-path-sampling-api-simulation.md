# 004 - Train Path Sampling Api Simulation
...
1. Add `trainPathQueryApi` to the tiny source fixture.
...
- Keep `trainPathQueryApi` as a source-data concern only.
