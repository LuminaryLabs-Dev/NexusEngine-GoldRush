# 004 - Train Path Sampling Api Research

Status: planned docs-only
Parent atom: `011-rail-and-train-reference-contract`
Source field: `trainPathQueryApi`

## Purpose

Document the source signals and design implications for `trainPathQueryApi` before future implementation.
...
What exact consumer echo proves `trainPathQueryApi` is source-owned and not inferred from a mesh, cinematic helper, timer, or local train curve?
