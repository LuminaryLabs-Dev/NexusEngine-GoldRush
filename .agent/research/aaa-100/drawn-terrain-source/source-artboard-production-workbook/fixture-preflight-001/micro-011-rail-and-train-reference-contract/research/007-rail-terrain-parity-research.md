# 007 - Rail Terrain Parity Research
...
Document the source signals and design implications for `railTerrainParity` before future implementation.
...
What exact consumer echo proves `railTerrainParity` is source-owned and not inferred from a mesh, cinematic helper, timer, or local train curve?
