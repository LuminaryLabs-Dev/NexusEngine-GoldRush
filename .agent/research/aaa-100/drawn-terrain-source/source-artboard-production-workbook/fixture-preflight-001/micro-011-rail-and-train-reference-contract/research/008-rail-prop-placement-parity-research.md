# 008 - Rail Prop Placement Parity Research
...
Document the source signals and design implications for `railPropPlacementEcho` before future implementation.
...
What exact consumer echo proves `railPropPlacementEcho` is source-owned and not inferred from a mesh, cinematic helper, timer, or local train curve?
