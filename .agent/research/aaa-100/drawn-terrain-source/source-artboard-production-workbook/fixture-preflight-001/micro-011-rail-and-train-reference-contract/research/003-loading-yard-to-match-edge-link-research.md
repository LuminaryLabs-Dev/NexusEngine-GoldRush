# 003 - Loading Yard To Match Edge Link Research
...
Document the source signals and design implications for `loadingYardMapEdgeLinks` before future implementation.
...
What exact consumer echo proves `loadingYardMapEdgeLinks` is source-owned and not inferred from a mesh, cinematic helper, timer, or local train curve?
