# 011 - Rail Negative Fixture Cases Research
...
Document the source signals and design implications for `railNegativeCases` before future implementation.
...
What exact consumer echo proves `railNegativeCases` is source-owned and not inferred from a mesh, cinematic helper, timer, or local train curve?
