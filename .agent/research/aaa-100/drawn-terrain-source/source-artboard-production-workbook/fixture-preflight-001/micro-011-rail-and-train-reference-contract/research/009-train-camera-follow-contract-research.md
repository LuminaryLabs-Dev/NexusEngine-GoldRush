# 009 - Train Camera Follow Contract Research
...
Document the source signals and design implications for `trainCameraRailHandoff` before future implementation.
...
What exact consumer echo proves `trainCameraRailHandoff` is source-owned and not inferred from a mesh, cinematic helper, timer, or local train curve?
