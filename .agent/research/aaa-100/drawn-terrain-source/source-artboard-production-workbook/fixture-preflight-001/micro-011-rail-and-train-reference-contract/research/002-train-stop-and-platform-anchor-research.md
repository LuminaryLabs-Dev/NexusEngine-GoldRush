# 002 - Train Stop And Platform Anchor Research
...
Document the source signals and design implications for `trainStopAnchors` before future implementation.
...
What exact consumer echo proves `trainStopAnchors` is source-owned and not inferred from a mesh, cinematic helper, timer, or local train curve?
