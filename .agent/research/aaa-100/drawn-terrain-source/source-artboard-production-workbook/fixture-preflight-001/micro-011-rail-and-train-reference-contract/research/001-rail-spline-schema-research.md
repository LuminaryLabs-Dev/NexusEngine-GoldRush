# 001 - Rail Spline Schema Research
...
Document the source signals and design implications for `railSplines` before future implementation.
...
What exact consumer echo proves `railSplines` is source-owned and not inferred from a mesh, cinematic helper, timer, or local train curve?
