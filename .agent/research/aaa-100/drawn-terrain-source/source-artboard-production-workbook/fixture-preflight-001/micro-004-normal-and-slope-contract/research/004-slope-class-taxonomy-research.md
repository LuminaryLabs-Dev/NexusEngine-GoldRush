# 004 - Slope Class Taxonomy Research
...
What external and local architecture signals constrain `slopeClass` before implementation?
...
- Terrain raycast owns query output for `slopeClass`.
...
- Validator needs one negative case where gameplay logic invents walkability labels outside the terrain source contract.
