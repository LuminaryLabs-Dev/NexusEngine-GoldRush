# 007 - Gradient Sample Neighborhood Research
...
What external and local architecture signals constrain `gradientKernel` before implementation?
...
- Terrain raycast owns query output for `gradientKernel`.
...
- Validator needs one negative case where slope flips or pulses across cells because each consumer samples a different neighborhood.
