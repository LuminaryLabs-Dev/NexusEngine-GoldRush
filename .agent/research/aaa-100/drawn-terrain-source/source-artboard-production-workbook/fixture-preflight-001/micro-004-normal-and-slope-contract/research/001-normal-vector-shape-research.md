# 001 - Normal Vector Shape Research
...
What external and local architecture signals constrain `normal` before implementation?
...
- Terrain raycast owns query output for `normal`.
...
- Validator needs one negative case where movement and placement accept malformed normals that only work in renderer lighting.
