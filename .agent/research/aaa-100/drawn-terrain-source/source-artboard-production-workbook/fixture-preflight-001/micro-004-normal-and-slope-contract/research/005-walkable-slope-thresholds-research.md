# 005 - Walkable Slope Thresholds Research
...
What external and local architecture signals constrain `walkableSlopeThresholds` before implementation?
...
- Terrain raycast owns query output for `walkableSlopeThresholds`.
...
- Validator needs one negative case where the player can climb mountains or gets blocked on gentle terrain because thresholds are duplicated.
