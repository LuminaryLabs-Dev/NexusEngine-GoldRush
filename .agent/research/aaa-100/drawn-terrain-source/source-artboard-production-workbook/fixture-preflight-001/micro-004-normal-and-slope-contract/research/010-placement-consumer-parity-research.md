# 010 - Placement Consumer Parity Research
...
What external and local architecture signals constrain `placementNormalEcho` before implementation?
...
- Terrain raycast owns query output for `placementNormalEcho`.
...
- Validator needs one negative case where rocks, plants, mines, and cashout props look grounded but are aligned by renderer fallback.
