# 008 - Sample Ground Api Shape Research
...
What external and local architecture signals constrain `sampleGroundApi` before implementation?
...
- Terrain raycast owns query output for `sampleGroundApi`.
...
- Validator needs one negative case where height, normal, and slope are queried separately and drift between systems.
