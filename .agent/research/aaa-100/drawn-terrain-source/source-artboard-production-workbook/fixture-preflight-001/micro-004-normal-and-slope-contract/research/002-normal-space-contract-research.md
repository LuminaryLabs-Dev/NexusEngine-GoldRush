# 002 - Normal Space Contract Research
...
What external and local architecture signals constrain `normalSpace` before implementation?
...
- Terrain raycast owns query output for `normalSpace`.
...
- Validator needs one negative case where character grounding, prop alignment, and lighting use normals from different coordinate spaces.
