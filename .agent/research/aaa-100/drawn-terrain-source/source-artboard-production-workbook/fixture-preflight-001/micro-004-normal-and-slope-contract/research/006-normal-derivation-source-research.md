# 006 - Normal Derivation Source Research
...
What external and local architecture signals constrain `normalDerivation` before implementation?
...
- Terrain raycast owns query output for `normalDerivation`.
...
- Validator needs one negative case where renderer-generated normals become gameplay truth without source validation.
