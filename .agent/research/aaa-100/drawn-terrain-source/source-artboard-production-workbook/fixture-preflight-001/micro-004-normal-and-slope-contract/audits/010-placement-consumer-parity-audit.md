# 010 - Placement Consumer Parity Audit
...
The normal and slope pass can fake completion if `placementNormalEcho` exists but consumers do not use it.

## Why It Matters

rocks, plants, mines, and cashout props look grounded but are aligned by renderer fallback.
...
Do not mark this micro-step resolved until prop placement snapshot echoes source normal and slope used for alignment or rejection and the validator catches the opposite failure.
