# 005 - Walkable Slope Thresholds Audit
...
The normal and slope pass can fake completion if `walkableSlopeThresholds` exists but consumers do not use it.

## Why It Matters

the player can climb mountains or gets blocked on gentle terrain because thresholds are duplicated.
...
Do not mark this micro-step resolved until movement proof can name slope thresholds for walk, slow, slide, and blocked results and the validator catches the opposite failure.
