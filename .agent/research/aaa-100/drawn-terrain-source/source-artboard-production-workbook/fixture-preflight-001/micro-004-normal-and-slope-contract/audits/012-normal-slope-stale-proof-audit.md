# 012 - Normal Slope Stale Proof Audit
...
The normal and slope pass can fake completion if `normalSlopeRevisionPolicy` exists but consumers do not use it.

## Why It Matters

old movement or placement caches survive after source terrain slope changes.
...
Do not mark this micro-step resolved until normal or slope changes mark movement, placement, collider, screenshot, and public proof stale and the validator catches the opposite failure.
