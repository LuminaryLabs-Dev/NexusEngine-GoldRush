# 012 - Normal Slope Stale Proof Simulation
...
1. Add `normalSlopeRevisionPolicy` to the future source fixture schema or sampleGround result.
...
The first failure should be a validator error proving that old movement or placement caches survive after source terrain slope changes.
