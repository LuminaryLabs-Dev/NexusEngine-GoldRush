# 009 - Movement Consumer Parity Simulation
...
1. Add `movementGroundEcho` to the future source fixture schema or sampleGround result.
...
The first failure should be a validator error proving that camera and character feel stable in proof while movement still uses hidden slope logic.
