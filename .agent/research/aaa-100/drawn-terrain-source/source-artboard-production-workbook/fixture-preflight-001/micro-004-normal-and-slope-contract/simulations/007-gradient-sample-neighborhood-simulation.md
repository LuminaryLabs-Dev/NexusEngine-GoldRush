# 007 - Gradient Sample Neighborhood Simulation
...
1. Add `gradientKernel` to the future source fixture schema or sampleGround result.
...
The first failure should be a validator error proving that slope flips or pulses across cells because each consumer samples a different neighborhood.
