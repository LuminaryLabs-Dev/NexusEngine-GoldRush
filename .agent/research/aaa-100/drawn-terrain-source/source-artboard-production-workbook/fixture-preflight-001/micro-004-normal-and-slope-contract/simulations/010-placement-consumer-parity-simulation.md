# 010 - Placement Consumer Parity Simulation
...
1. Add `placementNormalEcho` to the future source fixture schema or sampleGround result.
...
The first failure should be a validator error proving that rocks, plants, mines, and cashout props look grounded but are aligned by renderer fallback.
