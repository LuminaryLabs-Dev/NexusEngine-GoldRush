...
Make `normalSpace` small enough for a future implementation pass.

## Source Field

- Required field: `normalSpace`.
...
- Fail when `normalSpace` is missing, non-finite, contradictory, unversioned, non-source-owned, or silently inferred by a consumer.
...
Stop if this micro-step can pass while character grounding, prop alignment, and lighting use normals from different coordinate spaces.
