# 004 - Route Node And Segment Id Simulation
...
1. Future code adds or loads `routeNodesAndSegments` from the fixture.
...
- Add a closed source field for `routeNodesAndSegments`.
