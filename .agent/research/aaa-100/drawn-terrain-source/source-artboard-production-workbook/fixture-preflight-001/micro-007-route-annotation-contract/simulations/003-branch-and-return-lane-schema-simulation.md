# 003 - Branch And Return Lane Schema Simulation
...
1. Future code adds or loads `branchReturnLanes` from the fixture.
...
- Add a closed source field for `branchReturnLanes`.
