# 006 - Route Cost Risk And Speed Tags Simulation
...
1. Future code adds or loads `routeCostRiskTags` from the fixture.
...
- Add a closed source field for `routeCostRiskTags`.
