# 005 - Route Width And Corridor Budget Simulation
...
1. Future code adds or loads `routeCorridorBudget` from the fixture.
...
- Add a closed source field for `routeCorridorBudget`.
