# 008 - Route Proof Points Research
...
What external and local architecture signals constrain `routeProofPoints` before implementation?
...
- Route annotations own query output for `routeProofPoints`.
...
The likely fake-completion path is proving a random route point while forks, objectives, and recovery paths remain untested.
