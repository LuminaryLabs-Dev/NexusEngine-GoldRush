# 001 - Primary Route Schema Research
...
What external and local architecture signals constrain `primaryRoute` before implementation?
...
- Route annotations own query output for `primaryRoute`.
...
The likely fake-completion path is a visible trail mesh that route guidance, bots, and gameplay do not consume.
