# 003 - Branch And Return Lane Schema Research
...
What external and local architecture signals constrain `branchReturnLanes` before implementation?
...
- Route annotations own query output for `branchReturnLanes`.
...
The likely fake-completion path is route guidance pointing to objectives directly without authored approach and exit lanes.
