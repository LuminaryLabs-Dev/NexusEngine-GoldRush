...
Make `routeNodesAndSegments` small enough for a future implementation pass.

## Source Field

- Required field: `routeNodesAndSegments`.
...
- Fail when `routeNodesAndSegments` is missing, disconnected, unknown, contradictory, unversioned, non-source-owned, or silently inferred by a consumer.
