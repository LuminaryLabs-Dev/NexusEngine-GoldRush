...
Make `alternateRoutes` small enough for a future implementation pass.

## Source Field

- Required field: `alternateRoutes`.
...
- Fail when `alternateRoutes` is missing, disconnected, unknown, contradictory, unversioned, non-source-owned, or silently inferred by a consumer.
