...
Make `getZoneAtRouteQuery` small enough for a future implementation pass.

## Source Field

- Required field: `getZoneAtRouteQuery`.
...
- Fail when `getZoneAtRouteQuery` is missing, disconnected, unknown, contradictory, unversioned, non-source-owned, or silently inferred by a consumer.
