# 011 - Route Negative Fixture Cases
...
Make `routeNegativeCases` small enough for a future implementation pass.

## Source Field

- Required field: `routeNegativeCases`.
...
- Fail when `routeNegativeCases` is missing, disconnected, unknown, contradictory, unversioned, non-source-owned, or silently inferred by a consumer.
