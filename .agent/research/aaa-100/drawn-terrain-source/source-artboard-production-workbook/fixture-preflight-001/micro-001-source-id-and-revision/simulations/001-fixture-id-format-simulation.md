# 001 - Fixture Id Format Simulation
...
1. Add the minimum source field for fixtureId exact string and namespace pattern.
2. Add the negative validator case.
3. Expose the value in the source fixture snapshot.
4. Require one consumer echo.
5. Prove validator rejects ids outside goldrush.desert.artboard.fixture.*.
