# 001 - Fixture Id Format Research
...
- Data contract: fixtureId exact string and namespace pattern.
- Proof contract: validator rejects ids outside goldrush.desert.artboard.fixture.*.
- Risk constrained: fixture identity becomes a loose label instead of a stable source contract.
