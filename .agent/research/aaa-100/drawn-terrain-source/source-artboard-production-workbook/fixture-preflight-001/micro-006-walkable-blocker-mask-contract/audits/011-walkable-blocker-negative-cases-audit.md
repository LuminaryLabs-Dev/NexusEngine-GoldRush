# 011 - Walkable Blocker Negative Cases Audit
...
`walkableBlockerNegativeCases` can appear complete if the runtime only proves a finite terrain height, a visible mesh, or a local movement rejection.
...
- Require source-owned `walkableBlockerNegativeCases`.
