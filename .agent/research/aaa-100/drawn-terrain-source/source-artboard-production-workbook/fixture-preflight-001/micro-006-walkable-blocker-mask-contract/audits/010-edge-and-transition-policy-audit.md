# 010 - Edge And Transition Policy Audit
...
`walkabilityEdgePolicy` can appear complete if the runtime only proves a finite terrain height, a visible mesh, or a local movement rejection.
...
- Require source-owned `walkabilityEdgePolicy`.
