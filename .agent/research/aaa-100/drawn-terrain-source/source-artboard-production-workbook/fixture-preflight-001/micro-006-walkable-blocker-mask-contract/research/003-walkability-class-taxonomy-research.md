# 003 - Walkability Class Taxonomy Research
...
What external and local architecture signals constrain `walkabilityClasses` before implementation?
...
- Walkability and blocker masks own query output for `walkabilityClasses`.
...
The likely fake-completion path is a permissive default class that lets test paths pass while bad cells remain ambiguous.
