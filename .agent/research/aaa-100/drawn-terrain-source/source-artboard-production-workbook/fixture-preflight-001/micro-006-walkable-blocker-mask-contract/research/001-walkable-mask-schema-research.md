# 001 - Walkable Mask Schema Research
...
What external and local architecture signals constrain `walkableMask` before implementation?
...
- Walkability and blocker masks own query output for `walkableMask`.
...
The likely fake-completion path is treating any finite height as walkable just because the collider can return a y value.
