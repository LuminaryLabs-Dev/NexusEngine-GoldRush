# 012 - Walkable Blocker Stale Proof Research
...
What external and local architecture signals constrain `walkableBlockerRevisionPolicy` before implementation?
...
- Walkability and blocker masks own query output for `walkableBlockerRevisionPolicy`.
...
The likely fake-completion path is updating masks without invalidating movement caches, placement batches, AI routes, or retained proof reports.
