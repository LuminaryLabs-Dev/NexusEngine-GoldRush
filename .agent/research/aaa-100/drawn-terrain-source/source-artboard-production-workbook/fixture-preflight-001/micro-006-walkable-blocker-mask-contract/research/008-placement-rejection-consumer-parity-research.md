# 008 - Placement Rejection Consumer Parity Research
...
What external and local architecture signals constrain `placementWalkabilityEcho` before implementation?
...
- Walkability and blocker masks own query output for `placementWalkabilityEcho`.
...
The likely fake-completion path is downward raycast placement using height only while blocker masks are ignored.
