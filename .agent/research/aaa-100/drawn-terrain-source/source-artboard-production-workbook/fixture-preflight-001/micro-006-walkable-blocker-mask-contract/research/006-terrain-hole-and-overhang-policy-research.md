# 006 - Terrain Hole And Overhang Policy Research
...
What external and local architecture signals constrain `holeOverhangPolicy` before implementation?
...
- Walkability and blocker masks own query output for `holeOverhangPolicy`.
...
The likely fake-completion path is a heightfield-only proof pretending to support caves, bridges, or overhangs without declaring them unsupported.
