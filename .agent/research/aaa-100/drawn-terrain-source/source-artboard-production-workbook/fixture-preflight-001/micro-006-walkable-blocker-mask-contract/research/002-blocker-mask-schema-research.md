# 002 - Blocker Mask Schema Research
...
What external and local architecture signals constrain `blockerMask` before implementation?
...
- Walkability and blocker masks own query output for `blockerMask`.
...
The likely fake-completion path is showing a visual mountain while movement, placement, AI, and proof have no blocker id to reject against.
