# 007 - Movement Rejection Consumer Parity
...
Make `movementWalkabilityEcho` small enough for a future implementation pass.

## Source Field

- Required field: `movementWalkabilityEcho`.
...
- Fail when `movementWalkabilityEcho` is missing, unknown, contradictory, unversioned, non-source-owned, or silently inferred by a consumer.
