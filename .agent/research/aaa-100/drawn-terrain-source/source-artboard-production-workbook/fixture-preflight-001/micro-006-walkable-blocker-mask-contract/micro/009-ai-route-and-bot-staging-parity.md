# 009 - AI Route And Bot Staging Parity
...
Make `aiRouteWalkabilityEcho` small enough for a future implementation pass.

## Source Field

- Required field: `aiRouteWalkabilityEcho`.
...
- Fail when `aiRouteWalkabilityEcho` is missing, unknown, contradictory, unversioned, non-source-owned, or silently inferred by a consumer.
