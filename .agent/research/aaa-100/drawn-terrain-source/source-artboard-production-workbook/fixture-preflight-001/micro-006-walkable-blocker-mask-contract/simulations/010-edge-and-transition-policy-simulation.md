# 010 - Edge And Transition Policy Simulation
...
1. Future code adds or loads `walkabilityEdgePolicy` from the fixture.
...
- Add a closed source field for `walkabilityEdgePolicy`.
