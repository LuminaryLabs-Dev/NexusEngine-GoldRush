# 012 - Walkable Blocker Stale Proof Simulation
...
1. Future code adds or loads `walkableBlockerRevisionPolicy` from the fixture.
...
- Add a closed source field for `walkableBlockerRevisionPolicy`.
