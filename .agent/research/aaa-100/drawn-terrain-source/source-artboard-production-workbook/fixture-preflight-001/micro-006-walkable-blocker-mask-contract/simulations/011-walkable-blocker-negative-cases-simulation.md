# 011 - Walkable Blocker Negative Cases Simulation
...
1. Future code adds or loads `walkableBlockerNegativeCases` from the fixture.
...
- Add a closed source field for `walkableBlockerNegativeCases`.
