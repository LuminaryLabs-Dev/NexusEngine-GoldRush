# 003 - Walkability Class Taxonomy Simulation
...
1. Future code adds or loads `walkabilityClasses` from the fixture.
...
- Add a closed source field for `walkabilityClasses`.
