# 007 - Movement Rejection Consumer Parity Simulation
...
1. Future code adds or loads `movementWalkabilityEcho` from the fixture.
...
- Add a closed source field for `movementWalkabilityEcho`.
