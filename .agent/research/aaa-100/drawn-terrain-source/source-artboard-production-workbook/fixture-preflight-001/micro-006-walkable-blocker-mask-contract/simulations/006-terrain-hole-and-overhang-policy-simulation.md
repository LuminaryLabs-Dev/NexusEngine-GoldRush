# 006 - Terrain Hole And Overhang Policy Simulation
...
1. Future code adds or loads `holeOverhangPolicy` from the fixture.
...
- Add a closed source field for `holeOverhangPolicy`.
