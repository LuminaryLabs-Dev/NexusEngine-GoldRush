# 008 - Audio Vfx Surface Consumer Parity
...
Make `audioVfxSurfaceEcho` small enough for a future implementation pass.

## Source Field

- Required field: `audioVfxSurfaceEcho`.
...
- Fail when `audioVfxSurfaceEcho` is missing, unknown, non-finite, contradictory, unversioned, non-source-owned, or silently inferred by a consumer.
...
Stop if this micro-step can pass while footstep, mining, dust, hit, and ambience cues stay generic even when the terrain visually changes.
