# 011 - Mask Negative Fixture Cases Simulation
...
1. Add `maskNegativeCases` to the future source fixture schema or terrain surface query result.
...
The first failure should be a validator error proving that validation only checks that a mask exists and misses broken material or biome contracts.
