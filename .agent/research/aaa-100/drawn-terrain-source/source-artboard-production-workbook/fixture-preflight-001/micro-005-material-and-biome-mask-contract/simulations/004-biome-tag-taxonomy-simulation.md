# 004 - Biome Tag Taxonomy Simulation
...
1. Add `biomeTags` to the future source fixture schema or terrain surface query result.
...
The first failure should be a validator error proving that map regions look different but do not drive placement, route readability, or gameplay pressure consistently.
