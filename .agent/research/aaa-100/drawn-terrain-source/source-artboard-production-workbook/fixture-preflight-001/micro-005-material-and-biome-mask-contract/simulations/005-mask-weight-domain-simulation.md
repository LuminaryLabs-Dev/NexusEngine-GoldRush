# 005 - Mask Weight Domain Simulation
...
1. Add `maskWeights` to the future source fixture schema or terrain surface query result.
...
The first failure should be a validator error proving that layer blending hides invalid masks and consumers disagree about the dominant terrain surface.
