# 002 - Biome Mask Schema Simulation
...
1. Add `biomeMask` to the future source fixture schema or terrain surface query result.
...
The first failure should be a validator error proving that asset scatter and gameplay zones invent biome identity outside the source fixture.
