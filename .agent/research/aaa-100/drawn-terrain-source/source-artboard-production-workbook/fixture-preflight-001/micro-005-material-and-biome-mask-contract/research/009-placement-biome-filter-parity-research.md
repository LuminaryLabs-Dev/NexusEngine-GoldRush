# 009 - Placement Biome Filter Parity Research
...
What external and local architecture signals constrain `placementBiomeEcho` before implementation?
...
- Terrain material mask owns query output for `placementBiomeEcho`.
...
- Validator needs one negative case where rocks, plants, rails, camps, and gold props scatter from renderer geometry rather than authored surface intent.
