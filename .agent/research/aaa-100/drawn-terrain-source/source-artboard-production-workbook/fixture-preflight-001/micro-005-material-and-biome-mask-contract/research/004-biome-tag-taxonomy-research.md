# 004 - Biome Tag Taxonomy Research
...
What external and local architecture signals constrain `biomeTags` before implementation?
...
- Terrain material mask owns query output for `biomeTags`.
...
- Validator needs one negative case where map regions look different but do not drive placement, route readability, or gameplay pressure consistently.
