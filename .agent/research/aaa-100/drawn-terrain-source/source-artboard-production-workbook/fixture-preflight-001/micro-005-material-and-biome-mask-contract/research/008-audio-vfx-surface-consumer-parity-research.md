# 008 - Audio Vfx Surface Consumer Parity Research
...
What external and local architecture signals constrain `audioVfxSurfaceEcho` before implementation?
...
- Terrain material mask owns query output for `audioVfxSurfaceEcho`.
...
- Validator needs one negative case where footstep, mining, dust, hit, and ambience cues stay generic even when the terrain visually changes.
