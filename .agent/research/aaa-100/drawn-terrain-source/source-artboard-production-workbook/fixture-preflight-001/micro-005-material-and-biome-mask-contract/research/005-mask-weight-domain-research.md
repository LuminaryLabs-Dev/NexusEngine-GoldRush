# 005 - Mask Weight Domain Research
...
What external and local architecture signals constrain `maskWeights` before implementation?
...
- Terrain material mask owns query output for `maskWeights`.
...
- Validator needs one negative case where layer blending hides invalid masks and consumers disagree about the dominant terrain surface.
