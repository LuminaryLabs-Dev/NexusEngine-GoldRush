# 006 - Layer Priority And Blend Policy Research
...
What external and local architecture signals constrain `layerBlendPolicy` before implementation?
...
- Terrain material mask owns query output for `layerBlendPolicy`.
...
- Validator needs one negative case where Unity-like terrain painting and Unreal-like layer blending semantics are mixed without a source rule.
