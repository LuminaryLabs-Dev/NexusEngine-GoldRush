# 001 - Material Mask Schema Research
...
What external and local architecture signals constrain `materialMask` before implementation?
...
- Terrain material mask owns query output for `materialMask`.
...
- Validator needs one negative case where renderer fills missing surface identity with a default color while gameplay and audio know nothing about it.
