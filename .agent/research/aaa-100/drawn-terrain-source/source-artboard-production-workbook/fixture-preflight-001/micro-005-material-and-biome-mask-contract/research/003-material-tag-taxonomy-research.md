# 003 - Material Tag Taxonomy Research
...
What external and local architecture signals constrain `materialTags` before implementation?
...
- Terrain material mask owns query output for `materialTags`.
...
- Validator needs one negative case where render, audio, VFX, and placement use inconsistent names for the same ground surface.
