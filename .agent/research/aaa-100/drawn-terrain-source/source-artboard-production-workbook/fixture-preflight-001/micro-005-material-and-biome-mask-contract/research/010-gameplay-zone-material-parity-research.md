# 010 - Gameplay Zone Material Parity Research
...
What external and local architecture signals constrain `gameplaySurfaceEcho` before implementation?
...
- Terrain material mask owns query output for `gameplaySurfaceEcho`.
...
- Validator needs one negative case where receipts prove actions that were detached from the authored terrain surface and biome context.
