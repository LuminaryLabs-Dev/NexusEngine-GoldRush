# 012 - Material Biome Stale Proof Research
...
What external and local architecture signals constrain `materialBiomeRevisionPolicy` before implementation?
...
- Terrain material mask owns query output for `materialBiomeRevisionPolicy`.
...
- Validator needs one negative case where old renderer batches, object placements, or proof screenshots survive after surface identity changes.
