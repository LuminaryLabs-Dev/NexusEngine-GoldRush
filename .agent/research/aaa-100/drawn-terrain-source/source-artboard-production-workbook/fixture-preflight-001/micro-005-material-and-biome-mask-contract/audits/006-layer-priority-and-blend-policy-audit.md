# 006 - Layer Priority And Blend Policy Audit
...
The material and biome pass can fake completion if `layerBlendPolicy` exists but consumers do not use it.

## Why It Matters

Unity-like terrain painting and Unreal-like layer blending semantics are mixed without a source rule.
...
Do not mark this micro-step resolved until source fixture declares base layer, override layers, blend mode, and tie-break behavior and the validator catches the opposite failure.
