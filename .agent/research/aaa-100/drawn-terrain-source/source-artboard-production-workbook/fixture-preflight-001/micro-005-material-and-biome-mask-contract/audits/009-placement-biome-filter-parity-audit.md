# 009 - Placement Biome Filter Parity Audit
...
The material and biome pass can fake completion if `placementBiomeEcho` exists but consumers do not use it.

## Why It Matters

rocks, plants, rails, camps, and gold props scatter from renderer geometry rather than authored surface intent.
...
Do not mark this micro-step resolved until asset placement snapshot names material and biome tags used to accept or reject object anchors and the validator catches the opposite failure.
