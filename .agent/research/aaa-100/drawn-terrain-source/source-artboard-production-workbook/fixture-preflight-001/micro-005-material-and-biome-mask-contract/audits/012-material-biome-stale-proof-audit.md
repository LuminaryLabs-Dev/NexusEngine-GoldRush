# 012 - Material Biome Stale Proof Audit
...
The material and biome pass can fake completion if `materialBiomeRevisionPolicy` exists but consumers do not use it.

## Why It Matters

old renderer batches, object placements, or proof screenshots survive after surface identity changes.
...
Do not mark this micro-step resolved until material or biome changes mark render, audio, VFX, placement, gameplay, screenshot, and public proof stale and the validator catches the opposite failure.
