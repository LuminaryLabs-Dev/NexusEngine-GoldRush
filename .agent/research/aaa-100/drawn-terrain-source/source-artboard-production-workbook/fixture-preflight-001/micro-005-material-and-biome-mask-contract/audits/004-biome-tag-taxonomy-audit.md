...
The material and biome pass can fake completion if `biomeTags` exists but consumers do not use it.

## Why It Matters

map regions look different but do not drive placement, route readability, or gameplay pressure consistently.
...
Do not mark this micro-step resolved until source fixture exposes a closed biome set for basin, mesa, wash, mine-shelf, town-shelf, rail-bed, gold-seam, and extraction-site regions and the validator catches the opposite failure.
