# 003 - Material Tag Taxonomy Audit
...
The material and biome pass can fake completion if `materialTags` exists but consumers do not use it.

## Why It Matters

render, audio, VFX, and placement use inconsistent names for the same ground surface.
...
Do not mark this micro-step resolved until source fixture exposes a closed tag set for sand, rock, gravel, clay, wood, rail, water, and mine-tailings surfaces and the validator catches the opposite failure.
