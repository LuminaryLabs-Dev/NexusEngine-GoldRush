...
The material and biome pass can fake completion if `biomeMask` exists but consumers do not use it.

## Why It Matters

asset scatter and gameplay zones invent biome identity outside the source fixture.
...
Do not mark this micro-step resolved until validator proves each source cell can report a desert biome tag or an explicit no-biome exception and the validator catches the opposite failure.
