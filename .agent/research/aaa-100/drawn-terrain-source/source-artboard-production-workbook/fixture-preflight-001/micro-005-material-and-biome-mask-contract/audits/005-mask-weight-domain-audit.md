...
The material and biome pass can fake completion if `maskWeights` exists but consumers do not use it.

## Why It Matters

layer blending hides invalid masks and consumers disagree about the dominant terrain surface.
...
Do not mark this micro-step resolved until validator rejects non-finite, negative, over-one, and under-specified blend weights and the validator catches the opposite failure.
