# 007 - Edge Sample Policy Simulation
...
1. Add `heightEdgePolicy` to the future source fixture schema or query result.
...
The first failure should be a validator error proving that map borders create invisible ledges, holes, or fallback heights.
