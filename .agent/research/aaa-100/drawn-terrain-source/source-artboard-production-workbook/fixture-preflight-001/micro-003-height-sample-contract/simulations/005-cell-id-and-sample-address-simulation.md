# 005 - Cell Id And Sample Address Simulation
...
1. Add `sourceCellId` to the future source fixture schema or query result.
...
The first failure should be a validator error proving that debugging cannot identify which authored cell caused a bad player-footing or prop-placement result.
