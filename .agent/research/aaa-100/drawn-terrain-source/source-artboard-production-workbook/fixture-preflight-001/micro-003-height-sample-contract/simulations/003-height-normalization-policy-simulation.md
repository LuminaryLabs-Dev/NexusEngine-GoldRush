# 003 - Height Normalization Policy Simulation
...
1. Add `heightNormalization` to the future source fixture schema or query result.
...
The first failure should be a validator error proving that render mesh and physics collider interpret the same number as different vertical positions.
