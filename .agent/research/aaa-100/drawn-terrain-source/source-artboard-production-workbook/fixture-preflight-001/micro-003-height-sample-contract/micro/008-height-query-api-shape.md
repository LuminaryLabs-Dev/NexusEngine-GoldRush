...
Make `sampleHeightApi` small enough for a future implementation pass.

## Source Field

- Required field: `sampleHeightApi`.
...
- Fail when `sampleHeightApi` is missing, non-finite, contradictory, unversioned, or silently inferred by a consumer.
...
Stop if this micro-step can pass while consumers call private helpers or duplicate height math outside the source kit.
