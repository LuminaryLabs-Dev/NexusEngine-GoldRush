# 012 - Height Revision Stale Proof
...
Make `heightRevisionPolicy` small enough for a future implementation pass.

## Source Field

- Required field: `heightRevisionPolicy`.
...
- Fail when `heightRevisionPolicy` is missing, non-finite, contradictory, unversioned, or silently inferred by a consumer.
...
Stop if this micro-step can pass while old consumer caches survive after source terrain height changes.
