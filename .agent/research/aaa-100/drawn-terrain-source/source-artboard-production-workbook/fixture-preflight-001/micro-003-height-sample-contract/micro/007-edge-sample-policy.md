...
Make `heightEdgePolicy` small enough for a future implementation pass.

## Source Field

- Required field: `heightEdgePolicy`.
...
- Fail when `heightEdgePolicy` is missing, non-finite, contradictory, unversioned, or silently inferred by a consumer.
...
edge and corner sample queries have explicit accept, clamp, or reject behavior.

## Stop Condition

Stop if this micro-step can pass while map borders create invisible ledges, holes, or fallback heights.
