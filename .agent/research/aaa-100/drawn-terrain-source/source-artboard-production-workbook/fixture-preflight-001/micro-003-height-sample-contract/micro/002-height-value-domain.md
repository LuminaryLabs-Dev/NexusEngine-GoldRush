...
Make `heightValueDomain` small enough for a future implementation pass.

## Source Field

- Required field: `heightValueDomain`.
...
- Fail when `heightValueDomain` is missing, non-finite, contradictory, unversioned, or silently inferred by a consumer.
...
Stop if this micro-step can pass while renderer or collider clamps invalid height data and hides source corruption.
