# 010 - Render Collider Height Parity
...
Make `heightConsumerParity` small enough for a future implementation pass.

## Source Field

- Required field: `heightConsumerParity`.
...
- Fail when `heightConsumerParity` is missing, non-finite, contradictory, unversioned, or silently inferred by a consumer.
...
Stop if this micro-step can pass while visual terrain and physical terrain diverge even though each has valid height samples.
