# 006 - Interpolation Mode Contract Research
...
What external and local architecture signals constrain `heightInterpolationMode` before implementation?
...
- World source owns `heightInterpolationMode`.
...
- Validator needs one negative case where collider, renderer, and gameplay query different heights between sample points.
