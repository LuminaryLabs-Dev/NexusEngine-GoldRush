# 009 - Known Proof Points Research
...
What external and local architecture signals constrain `heightProofPoints` before implementation?
...
- World source owns `heightProofPoints`.
...
- Validator needs one negative case where height proof passes on arbitrary points while gameplay-critical locations remain unproven.
