# 001 - Height Sample Array Shape Research
...
What external and local architecture signals constrain `heightSamples` before implementation?
...
- World source owns `heightSamples`.
...
- Validator needs one negative case where terrain code accepts an irregular or empty height grid and fills gaps procedurally.
