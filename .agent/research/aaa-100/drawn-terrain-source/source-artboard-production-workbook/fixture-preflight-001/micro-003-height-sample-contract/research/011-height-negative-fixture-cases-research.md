# 011 - Height Negative Fixture Cases Research
...
What external and local architecture signals constrain `heightNegativeCases` before implementation?
...
- World source owns `heightNegativeCases`.
...
- Validator needs one negative case where validation becomes an existence check and cannot catch broken terrain source data.
