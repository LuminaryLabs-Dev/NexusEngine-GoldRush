# 004 - Height Origin And Offset Research
...
What external and local architecture signals constrain `heightOriginOffset` before implementation?
...
- World source owns `heightOriginOffset`.
...
- Validator needs one negative case where the character floats or sinks because the visible mesh and grounding use different base heights.
