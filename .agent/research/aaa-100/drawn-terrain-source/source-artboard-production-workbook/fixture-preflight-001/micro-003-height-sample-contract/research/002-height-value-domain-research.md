# 002 - Height Value Domain Research
...
What external and local architecture signals constrain `heightValueDomain` before implementation?
...
- World source owns `heightValueDomain`.
...
- Validator needs one negative case where renderer or collider clamps invalid height data and hides source corruption.
