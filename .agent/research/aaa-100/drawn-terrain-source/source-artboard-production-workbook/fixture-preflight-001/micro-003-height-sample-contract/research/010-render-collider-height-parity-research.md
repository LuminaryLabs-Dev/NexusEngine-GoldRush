# 010 - Render Collider Height Parity Research
...
What external and local architecture signals constrain `heightConsumerParity` before implementation?
...
- World source owns `heightConsumerParity`.
...
- Validator needs one negative case where visual terrain and physical terrain diverge even though each has valid height samples.
