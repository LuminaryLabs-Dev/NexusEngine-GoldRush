# 005 - Cell Id And Sample Address Research
...
What external and local architecture signals constrain `sourceCellId` before implementation?
...
- World source owns `sourceCellId`.
...
- Validator needs one negative case where debugging cannot identify which authored cell caused a bad player-footing or prop-placement result.
