# 012 - Height Revision Stale Proof Research
...
What external and local architecture signals constrain `heightRevisionPolicy` before implementation?
...
- World source owns `heightRevisionPolicy`.
...
- Validator needs one negative case where old consumer caches survive after source terrain height changes.
