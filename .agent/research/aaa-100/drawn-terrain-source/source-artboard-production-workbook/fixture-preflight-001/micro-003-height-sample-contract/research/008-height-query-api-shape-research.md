# 008 - Height Query Api Shape Research
...
What external and local architecture signals constrain `sampleHeightApi` before implementation?
...
- World source owns `sampleHeightApi`.
...
- Validator needs one negative case where consumers call private helpers or duplicate height math outside the source kit.
