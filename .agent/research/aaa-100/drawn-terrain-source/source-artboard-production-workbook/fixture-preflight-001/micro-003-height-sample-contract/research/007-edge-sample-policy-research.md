# 007 - Edge Sample Policy Research
...
What external and local architecture signals constrain `heightEdgePolicy` before implementation?
...
- World source owns `heightEdgePolicy`.
...
- Validator needs one negative case where map borders create invisible ledges, holes, or fallback heights.
