# 005 - Cell Id And Sample Address Audit
...
The height sample pass can fake completion if `sourceCellId` exists but consumers do not use it.

## Why It Matters

debugging cannot identify which authored cell caused a bad player-footing or prop-placement result.
...
Do not mark this micro-step resolved until sampleHeight returns source cell id, sample index, and fractional coordinate context and the validator catches the opposite failure.
