# 004 - Height Origin And Offset Audit
...
The height sample pass can fake completion if `heightOriginOffset` exists but consumers do not use it.

## Why It Matters

the character floats or sinks because the visible mesh and grounding use different base heights.
...
Do not mark this micro-step resolved until sampleHeight reports source height, offset, and world height for proof points and the validator catches the opposite failure.
