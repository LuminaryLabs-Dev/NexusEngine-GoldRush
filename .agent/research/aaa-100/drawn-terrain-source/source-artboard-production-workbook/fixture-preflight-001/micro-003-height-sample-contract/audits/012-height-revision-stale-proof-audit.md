# 012 - Height Revision Stale Proof Audit
...
The height sample pass can fake completion if `heightRevisionPolicy` exists but consumers do not use it.

## Why It Matters

old consumer caches survive after source terrain height changes.
...
Do not mark this micro-step resolved until height sample changes mark render, collider, placement, gameplay, screenshot, and public proof stale and the validator catches the opposite failure.
