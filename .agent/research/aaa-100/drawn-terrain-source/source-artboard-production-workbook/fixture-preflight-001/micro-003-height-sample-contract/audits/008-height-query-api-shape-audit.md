# 008 - Height Query Api Shape Audit
...
The height sample pass can fake completion if `sampleHeightApi` exists but consumers do not use it.

## Why It Matters

consumers call private helpers or duplicate height math outside the source kit.
...
Do not mark this micro-step resolved until public API returns a serializable height hit object with finite world height and revision echo and the validator catches the opposite failure.
