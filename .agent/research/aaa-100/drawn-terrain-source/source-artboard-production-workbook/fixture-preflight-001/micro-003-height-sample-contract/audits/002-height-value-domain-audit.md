...
The height sample pass can fake completion if `heightValueDomain` exists but consumers do not use it.

## Why It Matters

renderer or collider clamps invalid height data and hides source corruption.
...
Do not mark this micro-step resolved until validator rejects NaN, infinite, string, null, and out-of-range height samples and the validator catches the opposite failure.
