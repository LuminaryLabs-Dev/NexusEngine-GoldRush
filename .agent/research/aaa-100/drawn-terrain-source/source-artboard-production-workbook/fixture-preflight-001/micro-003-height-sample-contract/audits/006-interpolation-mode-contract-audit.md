# 006 - Interpolation Mode Contract Audit
...
The height sample pass can fake completion if `heightInterpolationMode` exists but consumers do not use it.

## Why It Matters

collider, renderer, and gameplay query different heights between sample points.
...
Do not mark this micro-step resolved until sampleHeight declares nearest, bilinear, barycentric, or fixed-mode interpolation and the validator catches the opposite failure.
