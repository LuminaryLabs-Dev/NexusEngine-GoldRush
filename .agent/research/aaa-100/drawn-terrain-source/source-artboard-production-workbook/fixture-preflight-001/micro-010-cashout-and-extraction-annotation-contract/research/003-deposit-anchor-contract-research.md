# 003 - Deposit Anchor Contract Research
...
Document the source signals and design implications for `depositAnchors` before future implementation.
...
What exact consumer echo proves `depositAnchors` is source-owned and not inferred from a marker, primitive, helper, or scoring shortcut?
