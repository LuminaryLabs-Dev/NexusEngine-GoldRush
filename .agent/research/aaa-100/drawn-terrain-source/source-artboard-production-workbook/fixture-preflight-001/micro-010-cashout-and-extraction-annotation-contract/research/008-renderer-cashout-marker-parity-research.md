# 008 - Renderer Cashout Marker Parity Research
...
Document the source signals and design implications for `rendererCashoutEcho` before future implementation.
...
What exact consumer echo proves `rendererCashoutEcho` is source-owned and not inferred from a marker, primitive, helper, or scoring shortcut?
