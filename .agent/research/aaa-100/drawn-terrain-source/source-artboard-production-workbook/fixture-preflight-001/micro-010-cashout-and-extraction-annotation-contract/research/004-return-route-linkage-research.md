# 004 - Return Route Linkage Research
...
Document the source signals and design implications for `cashoutReturnRoutes` before future implementation.
...
What exact consumer echo proves `cashoutReturnRoutes` is source-owned and not inferred from a marker, primitive, helper, or scoring shortcut?
