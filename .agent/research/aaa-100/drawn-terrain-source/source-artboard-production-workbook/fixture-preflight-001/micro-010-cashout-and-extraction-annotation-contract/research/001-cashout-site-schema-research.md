# 001 - Cashout Site Schema Research
...
Document the source signals and design implications for `cashoutSites` before future implementation.
...
What exact consumer echo proves `cashoutSites` is source-owned and not inferred from a marker, primitive, helper, or scoring shortcut?
