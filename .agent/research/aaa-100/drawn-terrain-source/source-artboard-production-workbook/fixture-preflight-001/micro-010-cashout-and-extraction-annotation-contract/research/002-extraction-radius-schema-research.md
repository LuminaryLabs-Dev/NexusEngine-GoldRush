# 002 - Extraction Radius Schema Research
...
Document the source signals and design implications for `extractionRadii` before future implementation.
...
What exact consumer echo proves `extractionRadii` is source-owned and not inferred from a marker, primitive, helper, or scoring shortcut?
