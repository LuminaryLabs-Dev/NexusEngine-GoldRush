...
Audit `cashoutSites` as source-owned extraction destination annotation data, not as a visual marker, gameplay shortcut, or scoring helper.
...
- Add a validator case for `cashoutSites`.
