# 002 - Extraction Radius Schema Audit
...
Audit `extractionRadii` as source-owned extraction destination annotation data, not as a visual marker, gameplay shortcut, or scoring helper.
...
- Add a validator case for `extractionRadii`.
