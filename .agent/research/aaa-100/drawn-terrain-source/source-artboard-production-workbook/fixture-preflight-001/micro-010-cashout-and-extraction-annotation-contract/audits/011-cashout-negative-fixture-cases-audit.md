# 011 - Cashout Negative Fixture Cases Audit
...
Audit `cashoutNegativeCases` as source-owned extraction destination annotation data, not as a visual marker, gameplay shortcut, or scoring helper.
...
- Add a validator case for `cashoutNegativeCases`.
