# 006 - Vertical Range Budget Simulation
...
1. Add `heightRange` to the future source fixture schema.
...
The first failure should be a validator error proving that mountains become unreadable blockers or flat hills after scale changes.
