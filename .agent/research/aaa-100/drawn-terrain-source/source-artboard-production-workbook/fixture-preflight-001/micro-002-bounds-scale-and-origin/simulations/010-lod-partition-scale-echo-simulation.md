# 010 - LOD Partition Scale Echo Simulation
...
1. Add `scaleConsumers` to the future source fixture schema.
...
The first failure should be a validator error proving that visual streaming and 60-player room scale use different map dimensions.
