# 001 - World Coordinate System Simulation
...
1. Add `coordinateSystem` to the future source fixture schema.
...
The first failure should be a validator error proving that renderer, physics, placement, and gameplay interpret positions in different axes.
