# 009 - Spawn Route Scale Check Simulation
...
1. Add `scaleProofAnchors` to the future source fixture schema.
...
The first failure should be a validator error proving that the map is technically large but traversal pacing is not battle-royale readable.
