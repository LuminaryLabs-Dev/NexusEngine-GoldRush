# 003 - Playable Bounds Rectangle Simulation
...
1. Add `worldBounds` to the future source fixture schema.
...
The first failure should be a validator error proving that large terrain looks big but gameplay still happens in a tiny or undefined area.
