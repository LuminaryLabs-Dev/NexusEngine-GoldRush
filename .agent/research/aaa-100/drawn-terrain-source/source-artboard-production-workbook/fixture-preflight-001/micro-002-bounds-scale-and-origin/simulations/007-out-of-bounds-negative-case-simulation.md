# 007 - Out Of Bounds Negative Case Simulation
...
1. Add `boundsPolicy` to the future source fixture schema.
...
The first failure should be a validator error proving that players, bots, and props can exist beyond the authored map without explicit handling.
