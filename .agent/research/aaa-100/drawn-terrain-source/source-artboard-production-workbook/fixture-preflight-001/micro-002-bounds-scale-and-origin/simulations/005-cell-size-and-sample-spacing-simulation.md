# 005 - Cell Size And Sample Spacing Simulation
...
1. Add `cellSize` to the future source fixture schema.
...
The first failure should be a validator error proving that terrain seams and raycast mismatch appear because consumers resample at different spacing.
