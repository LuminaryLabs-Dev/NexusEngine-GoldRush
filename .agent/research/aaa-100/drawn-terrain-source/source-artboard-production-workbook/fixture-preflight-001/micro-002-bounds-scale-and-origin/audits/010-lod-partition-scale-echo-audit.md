# 010 - LOD Partition Scale Echo Audit
...
The bounds, scale, and origin pass can fake completion if `scaleConsumers` exists but consumers do not use it.

## Why It Matters

visual streaming and 60-player room scale use different map dimensions.
...
Do not mark this micro-step resolved until LOD cells and network partition descriptors echo bounds and unit scale and the validator catches the opposite failure.
