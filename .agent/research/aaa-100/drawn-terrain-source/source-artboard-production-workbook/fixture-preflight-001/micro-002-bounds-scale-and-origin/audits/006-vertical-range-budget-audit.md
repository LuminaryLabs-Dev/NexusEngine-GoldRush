# 006 - Vertical Range Budget Audit
...
The bounds, scale, and origin pass can fake completion if `heightRange` exists but consumers do not use it.

## Why It Matters

mountains become unreadable blockers or flat hills after scale changes.
...
Do not mark this micro-step resolved until height queries report min, max, and normalized range from the fixture and the validator catches the opposite failure.
