# 011 - Physics Render Scale Parity Audit
...
The bounds, scale, and origin pass can fake completion if `consumerScaleEcho` exists but consumers do not use it.

## Why It Matters

the player appears above, below, or inside terrain because visual and physical worlds disagree.
...
Do not mark this micro-step resolved until render mesh, collider, and raycast snapshots report identical bounds and scale and the validator catches the opposite failure.
