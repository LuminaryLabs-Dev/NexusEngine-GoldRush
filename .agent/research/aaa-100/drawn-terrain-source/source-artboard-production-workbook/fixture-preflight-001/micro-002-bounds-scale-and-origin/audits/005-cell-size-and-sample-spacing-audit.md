# 005 - Cell Size And Sample Spacing Audit
...
The bounds, scale, and origin pass can fake completion if `cellSize` exists but consumers do not use it.

## Why It Matters

terrain seams and raycast mismatch appear because consumers resample at different spacing.
...
Do not mark this micro-step resolved until height, mask, LOD, and placement samples report shared cell size and the validator catches the opposite failure.
