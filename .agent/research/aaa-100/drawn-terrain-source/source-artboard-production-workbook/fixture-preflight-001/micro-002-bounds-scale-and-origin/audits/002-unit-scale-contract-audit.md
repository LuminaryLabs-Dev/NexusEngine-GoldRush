...
The bounds, scale, and origin pass can fake completion if `unitScale` exists but consumers do not use it.

## Why It Matters

player speed, mountain size, collider size, and 60-player density drift apart.
...
Do not mark this micro-step resolved until queries echo meters-per-unit and reject missing or zero unit scale and the validator catches the opposite failure.
