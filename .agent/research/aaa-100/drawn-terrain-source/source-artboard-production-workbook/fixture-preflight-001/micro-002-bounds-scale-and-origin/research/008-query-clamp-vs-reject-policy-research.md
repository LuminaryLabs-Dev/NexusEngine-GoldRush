# 008 - Query Clamp Vs Reject Policy Research
...
What external and local architecture signals constrain `queryBoundsMode` before implementation?
...
- World source owns `queryBoundsMode`.
...
- Validator needs one negative case where debug proof passes by clamping broken points instead of exposing map boundary errors.
