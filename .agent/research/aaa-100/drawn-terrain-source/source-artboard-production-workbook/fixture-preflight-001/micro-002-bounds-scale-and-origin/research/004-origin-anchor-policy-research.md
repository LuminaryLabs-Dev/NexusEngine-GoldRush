# 004 - Origin Anchor Policy Research
...
What external and local architecture signals constrain `origin` before implementation?
...
- Validator needs one negative case where asset anchors and gameplay markers drift when the source artboard is moved.
