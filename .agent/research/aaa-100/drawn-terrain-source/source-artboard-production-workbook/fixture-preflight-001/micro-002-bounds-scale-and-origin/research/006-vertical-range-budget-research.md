# 006 - Vertical Range Budget Research
...
What external and local architecture signals constrain `heightRange` before implementation?
...
- Validator needs one negative case where mountains become unreadable blockers or flat hills after scale changes.
