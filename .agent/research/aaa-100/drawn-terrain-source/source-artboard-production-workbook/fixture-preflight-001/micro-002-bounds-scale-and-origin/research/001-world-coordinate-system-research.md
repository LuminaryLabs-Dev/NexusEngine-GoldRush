# 001 - World Coordinate System Research
...
What external and local architecture signals constrain `coordinateSystem` before implementation?
...
- World source owns `coordinateSystem`.
...
- Validator needs one negative case where renderer, physics, placement, and gameplay interpret positions in different axes.
