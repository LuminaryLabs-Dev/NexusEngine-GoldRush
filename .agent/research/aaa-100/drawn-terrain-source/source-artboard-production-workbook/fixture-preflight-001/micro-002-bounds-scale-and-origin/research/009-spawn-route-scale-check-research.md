# 009 - Spawn Route Scale Check Research
...
What external and local architecture signals constrain `scaleProofAnchors` before implementation?
...
- World source owns `scaleProofAnchors`.
...
- Validator needs one negative case where the map is technically large but traversal pacing is not battle-royale readable.
