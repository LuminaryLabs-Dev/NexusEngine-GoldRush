# 011 - Physics Render Scale Parity Research
...
What external and local architecture signals constrain `consumerScaleEcho` before implementation?
...
- World source owns `consumerScaleEcho`.
...
- Validator needs one negative case where the player appears above, below, or inside terrain because visual and physical worlds disagree.
