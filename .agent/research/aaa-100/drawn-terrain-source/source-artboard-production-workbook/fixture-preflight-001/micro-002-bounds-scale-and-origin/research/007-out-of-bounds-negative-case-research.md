# 007 - Out Of Bounds Negative Case Research
...
What external and local architecture signals constrain `boundsPolicy` before implementation?
...
- World source owns `boundsPolicy`.
...
- Validator needs one negative case where players, bots, and props can exist beyond the authored map without explicit handling.
