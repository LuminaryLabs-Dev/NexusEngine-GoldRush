# 002 - Unit Scale Contract Research
...
What external and local architecture signals constrain `unitScale` before implementation?
...
- Validator needs one negative case where player speed, mountain size, collider size, and 60-player density drift apart.
