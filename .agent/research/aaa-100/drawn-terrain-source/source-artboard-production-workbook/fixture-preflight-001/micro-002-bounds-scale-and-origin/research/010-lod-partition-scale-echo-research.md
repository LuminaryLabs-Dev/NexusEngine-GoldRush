# 010 - LOD Partition Scale Echo Research
...
What external and local architecture signals constrain `scaleConsumers` before implementation?
...
- World source owns `scaleConsumers`.
...
- Validator needs one negative case where visual streaming and 60-player room scale use different map dimensions.
