# 012 - Scale Restart Policy Research
...
What external and local architecture signals constrain `scaleRevisionPolicy` before implementation?
...
- World source owns `scaleRevisionPolicy`.
...
- Validator needs one negative case where old screenshots, caches, or public proof are reused after a map scale change.
