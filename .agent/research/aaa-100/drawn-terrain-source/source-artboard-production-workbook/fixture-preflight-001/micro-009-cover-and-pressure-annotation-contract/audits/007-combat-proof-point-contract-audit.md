# 007 - Combat Proof Point Contract Audit
...
Audit `combatProofPoints` as a source-owned terrain combat annotation, not as a visual threat lane or gameplay shortcut.
...
- Add a validator case for `combatProofPoints`.
