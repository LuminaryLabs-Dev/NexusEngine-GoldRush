# 003 - Pressure Seed Schema Audit
...
Audit `pressureSeeds` as a source-owned terrain combat annotation, not as a visual threat lane or gameplay shortcut.
...
- Add a validator case for `pressureSeeds`.
