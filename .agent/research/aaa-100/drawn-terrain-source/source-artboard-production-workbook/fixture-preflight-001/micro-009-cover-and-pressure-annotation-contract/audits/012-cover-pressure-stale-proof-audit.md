# 012 - Cover Pressure Stale Proof Audit
...
Audit `coverPressureRevisionPolicy` as a source-owned terrain combat annotation, not as a visual threat lane or gameplay shortcut.
...
- Add a validator case for `coverPressureRevisionPolicy`.
