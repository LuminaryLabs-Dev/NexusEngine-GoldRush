# 009 - Renderer Threat Readability Parity Audit
...
Audit `rendererThreatEcho` as a source-owned terrain combat annotation, not as a visual threat lane or gameplay shortcut.
...
- Add a validator case for `rendererThreatEcho`.
