# 008 - Pressure Query API Shape Audit
...
Audit `pressureQueryApi` as a source-owned terrain combat annotation, not as a visual threat lane or gameplay shortcut.
...
- Add a validator case for `pressureQueryApi`.
