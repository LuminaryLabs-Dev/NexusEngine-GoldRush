# 011 - Cover Pressure Negative Fixture Cases Audit
...
Audit `coverPressureNegativeCases` as a source-owned terrain combat annotation, not as a visual threat lane or gameplay shortcut.
...
- Add a validator case for `coverPressureNegativeCases`.
