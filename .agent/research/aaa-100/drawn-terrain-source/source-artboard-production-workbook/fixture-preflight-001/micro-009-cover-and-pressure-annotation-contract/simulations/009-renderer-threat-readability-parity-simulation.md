# 009 - Renderer Threat Readability Parity Simulation

Status: planned docs-only
Parent atom: `009-cover-and-pressure-annotation-contract`
Source field: `rendererThreatEcho`

## Simulated Implementation

1. Add `rendererThreatEcho` to the tiny source fixture.
...
- Keep `rendererThreatEcho` as a source-data concern only.
...
Future implementation is acceptable only if renderer snapshots echo source cover id, threat lane id, telegraph role, visibility band, and fixture revision and the stop condition cannot pass through helper-only, combat-only, or renderer-only state.
