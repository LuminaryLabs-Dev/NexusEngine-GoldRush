# 003 - Pressure Seed Schema Research
...
Document the source signals and design implications for `pressureSeeds` before future implementation.
...
What exact consumer echo proves `pressureSeeds` is source-owned and not inferred from a primitive, helper, or renderer-only threat lane?
