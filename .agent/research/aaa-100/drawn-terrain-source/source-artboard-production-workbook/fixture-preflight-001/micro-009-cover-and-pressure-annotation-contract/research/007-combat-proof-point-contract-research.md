# 007 - Combat Proof Point Contract Research
...
Document the source signals and design implications for `combatProofPoints` before future implementation.
...
What exact consumer echo proves `combatProofPoints` is source-owned and not inferred from a primitive, helper, or renderer-only threat lane?
