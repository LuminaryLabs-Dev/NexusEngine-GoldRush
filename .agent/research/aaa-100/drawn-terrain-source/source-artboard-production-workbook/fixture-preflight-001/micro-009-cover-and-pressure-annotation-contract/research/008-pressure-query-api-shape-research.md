# 008 - Pressure Query API Shape Research
...
Document the source signals and design implications for `pressureQueryApi` before future implementation.
...
What exact consumer echo proves `pressureQueryApi` is source-owned and not inferred from a primitive, helper, or renderer-only threat lane?
