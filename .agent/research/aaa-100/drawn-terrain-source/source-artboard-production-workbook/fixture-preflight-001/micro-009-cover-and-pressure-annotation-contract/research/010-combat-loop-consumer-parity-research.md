# 010 - Combat Loop Consumer Parity Research
...
Document the source signals and design implications for `combatLoopPressureEcho` before future implementation.
...
What exact consumer echo proves `combatLoopPressureEcho` is source-owned and not inferred from a primitive, helper, or renderer-only threat lane?
