# 002 - Threat Lane Schema Research
...
Document the source signals and design implications for `threatLanes` before future implementation.
...
What exact consumer echo proves `threatLanes` is source-owned and not inferred from a primitive, helper, or renderer-only threat lane?
