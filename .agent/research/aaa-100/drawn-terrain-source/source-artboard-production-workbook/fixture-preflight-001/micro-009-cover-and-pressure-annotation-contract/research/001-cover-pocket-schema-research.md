# 001 - Cover Pocket Schema Research
...
Document the source signals and design implications for `coverPockets` before future implementation.
...
What exact consumer echo proves `coverPockets` is source-owned and not inferred from a primitive, helper, or renderer-only threat lane?
