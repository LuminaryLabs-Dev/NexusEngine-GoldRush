...
Make `threatLanes` small enough for a future implementation pass.

## Source Field

- Required field: `threatLanes`.
...
- Fail when `threatLanes` is missing, duplicated, contradictory, unversioned, non-source-owned, renderer-inferred, helper-only, or silently replaced by a consumer.
