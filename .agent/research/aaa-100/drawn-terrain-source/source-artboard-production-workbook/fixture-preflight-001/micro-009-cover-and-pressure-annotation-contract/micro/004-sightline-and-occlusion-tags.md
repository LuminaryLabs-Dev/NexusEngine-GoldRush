# 004 - Sightline And Occlusion Tags
...
Make `sightlineOcclusionTags` small enough for a future implementation pass.

## Source Field

- Required field: `sightlineOcclusionTags`.
...
- Fail when `sightlineOcclusionTags` is missing, duplicated, contradictory, unversioned, non-source-owned, renderer-inferred, helper-only, or silently replaced by a consumer.
