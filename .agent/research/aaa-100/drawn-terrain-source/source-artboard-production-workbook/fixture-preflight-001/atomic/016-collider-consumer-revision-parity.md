# 016 - Collider Consumer Revision Parity

Status: planned docs-only
Fixture id: `goldrush.desert.artboard.fixture.001`
Domain: physics/runtime
Generic kit candidate: `n:physics:collider`
GoldRush kit candidate: `n:goldrush:terrain-physics`
...
- Source data: collider source revision and sample parity report.
- Public proof: collider samples match fixture height at test points.
...
Stop if this atom can pass without proving collider samples match fixture height at test points.
