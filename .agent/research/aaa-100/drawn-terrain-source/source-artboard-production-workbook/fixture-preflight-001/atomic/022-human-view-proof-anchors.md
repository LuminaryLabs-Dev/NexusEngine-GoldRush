...
- Source data: proof shot ids and expected readable content.
- Public proof: screenshots label foreground, midground, horizon, next action, and failure state.
...
Stop if this atom can pass without proving screenshots label foreground, midground, horizon, next action, and failure state.
