# 012 - Asset Anchor Family Contract

Status: planned docs-only
Fixture id: `goldrush.desert.artboard.fixture.001`
Domain: content/world
Generic kit candidate: `n:world:placement-anchors`
GoldRush kit candidate: `n:goldrush:desert-asset-family-protokits`
...
- Source data: asset anchor ids, family, mask, transform hints.
- Public proof: first prop placement reports anchor id and raycast hit.
...
Stop if this atom can pass without proving first prop placement reports anchor id and raycast hit.
