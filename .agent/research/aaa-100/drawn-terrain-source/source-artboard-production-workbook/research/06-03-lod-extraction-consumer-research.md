# Lod Extraction Consumer Research
...
What source-artboard evidence or external reference signal makes lod-extraction / consumer production-worthy for GoldRush?
...
The map needs a source-derived near, mid, far, and horizon LOD extraction policy.
