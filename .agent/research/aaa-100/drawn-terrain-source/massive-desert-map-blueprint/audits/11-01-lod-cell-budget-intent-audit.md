# LOD Cell Budget - Intent Hardening Audit

Status: active docs-only
Domain: performance / render / network
Generic kit: `n:world:terrain-chunks`
GoldRush kit: `n:goldrush:gold-field-lod`
Related atom: `atomic/11-01-lod-cell-budget-intent.md`
Related simulation: `simulations/11-01-lod-cell-budget-intent-simulation.md`

## Intention

Harden the player-facing purpose and ownership decision for near/mid/far/hidden cell budgets, LOD hysteresis, and source-revision cell proof so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
