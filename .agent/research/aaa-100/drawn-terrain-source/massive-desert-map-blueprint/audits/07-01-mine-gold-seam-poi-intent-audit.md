# Mine Gold Seam POI - Intent Hardening Audit

Status: active docs-only
Domain: gameplay / content / world
Generic kit: `n:world:placement-raycast`
GoldRush kit: `n:goldrush:gold-seam-protokits`
Related atom: `atomic/07-01-mine-gold-seam-poi-intent.md`
Related simulation: `simulations/07-01-mine-gold-seam-poi-intent-simulation.md`

## Intention

Harden the player-facing purpose and ownership decision for source-anchored mine mouth, gold seams, mining affordances, and risk reward placement so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
