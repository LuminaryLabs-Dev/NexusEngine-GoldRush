# LOD Cell Budget - Consumer Contract Hardening Audit

Status: active docs-only
Domain: performance / render / network
Generic kit: `n:world:terrain-chunks`
GoldRush kit: `n:goldrush:gold-field-lod`
Related atom: `atomic/11-03-lod-cell-budget-consumer.md`
Related simulation: `simulations/11-03-lod-cell-budget-consumer-simulation.md`

## Intention

Harden the kit consumers, public events, and snapshots for near/mid/far/hidden cell budgets, LOD hysteresis, and source-revision cell proof so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
