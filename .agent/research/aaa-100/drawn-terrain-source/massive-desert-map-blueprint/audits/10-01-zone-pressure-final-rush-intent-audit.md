# Zone Pressure Final Rush - Intent Hardening Audit

Status: active docs-only
Domain: battle royale / gameplay / world
Generic kit: `n:world:zone-mask`
GoldRush kit: `n:goldrush:final-rush-pressure`
Related atom: `atomic/10-01-zone-pressure-final-rush-intent.md`
Related simulation: `simulations/10-01-zone-pressure-final-rush-intent-simulation.md`

## Intention

Harden the player-facing purpose and ownership decision for battle-royale pressure corridors, late route choices, and fair closure lanes so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
