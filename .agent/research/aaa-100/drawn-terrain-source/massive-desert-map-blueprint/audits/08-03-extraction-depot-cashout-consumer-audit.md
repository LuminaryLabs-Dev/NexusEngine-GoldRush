# Extraction Depot Cashout - Consumer Contract Hardening Audit

Status: active docs-only
Domain: gameplay / world / presentation
Generic kit: `n:world:zone-mask`
GoldRush kit: `n:goldrush:cashout-sites`
Related atom: `atomic/08-03-extraction-depot-cashout-consumer.md`
Related simulation: `simulations/08-03-extraction-depot-cashout-consumer-simulation.md`

## Intention

Harden the kit consumers, public events, and snapshots for cashout depot landmark, reachable deposit route, contest space, and results receipts so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
