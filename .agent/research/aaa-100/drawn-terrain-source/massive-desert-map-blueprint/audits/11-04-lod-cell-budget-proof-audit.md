# LOD Cell Budget - Proof Gate Hardening Audit

Status: active docs-only
Domain: performance / render / network
Generic kit: `n:world:terrain-chunks`
GoldRush kit: `n:goldrush:gold-field-lod`
Related atom: `atomic/11-04-lod-cell-budget-proof.md`
Related simulation: `simulations/11-04-lod-cell-budget-proof-simulation.md`

## Intention

Harden the validator, screenshot, video, and deploy acceptance gate for near/mid/far/hidden cell budgets, LOD hysteresis, and source-revision cell proof so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
