# Rail Train Corridor - Consumer Contract Hardening Audit

Status: active docs-only
Domain: scene / world / extraction
Generic kit: `n:scene:transition`
GoldRush kit: `n:goldrush:train-loading`
Related atom: `atomic/05-03-rail-train-corridor-consumer.md`
Related simulation: `simulations/05-03-rail-train-corridor-consumer-simulation.md`

## Intention

Harden the kit consumers, public events, and snapshots for rail spline, train approach/departure, and extraction depot continuity so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
