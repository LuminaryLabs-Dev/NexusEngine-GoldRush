# Cover Combat Sightlines - Data Fixture Hardening Audit

Status: active docs-only
Domain: combat / world / camera
Generic kit: `n:world:line-of-sight`
GoldRush kit: `n:goldrush:combat-route-guidance`
Related atom: `atomic/09-02-cover-combat-sightlines-data.md`
Related simulation: `simulations/09-02-cover-combat-sightlines-data-simulation.md`

## Intention

Harden the serializable source data and mask/anchor fixture for cover pockets, sightline breaks, threat route readability, and camera-safe combat lanes so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
