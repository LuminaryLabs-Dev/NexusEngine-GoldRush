# Wash Route Network - Consumer Contract Hardening Audit

Status: active docs-only
Domain: world / control / staging
Generic kit: `n:world:route-graph`
GoldRush kit: `n:goldrush:player-route-guidance`
Related atom: `atomic/04-03-wash-route-network-consumer.md`
Related simulation: `simulations/04-03-wash-route-network-consumer-simulation.md`

## Intention

Harden the kit consumers, public events, and snapshots for dry wash travel lanes, bot route hints, and natural movement proof so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
