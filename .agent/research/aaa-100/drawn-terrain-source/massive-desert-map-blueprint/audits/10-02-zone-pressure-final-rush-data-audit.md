# Zone Pressure Final Rush - Data Fixture Hardening Audit

Status: active docs-only
Domain: battle royale / gameplay / world
Generic kit: `n:world:zone-mask`
GoldRush kit: `n:goldrush:final-rush-pressure`
Related atom: `atomic/10-02-zone-pressure-final-rush-data.md`
Related simulation: `simulations/10-02-zone-pressure-final-rush-data-simulation.md`

## Intention

Harden the serializable source data and mask/anchor fixture for battle-royale pressure corridors, late route choices, and fair closure lanes so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
