# Wash Route Network - Intent Hardening Audit

Status: active docs-only
Domain: world / control / staging
Generic kit: `n:world:route-graph`
GoldRush kit: `n:goldrush:player-route-guidance`
Related atom: `atomic/04-01-wash-route-network-intent.md`
Related simulation: `simulations/04-01-wash-route-network-intent-simulation.md`

## Intention

Harden the player-facing purpose and ownership decision for dry wash travel lanes, bot route hints, and natural movement proof so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
