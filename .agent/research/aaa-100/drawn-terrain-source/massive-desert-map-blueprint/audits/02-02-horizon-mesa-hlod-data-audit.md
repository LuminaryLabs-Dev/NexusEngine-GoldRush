# Horizon Mesa HLOD - Data Fixture Hardening Audit

Status: active docs-only
Domain: render / performance / world
Generic kit: `n:world:terrain-chunks`
GoldRush kit: `n:goldrush:gold-field-lod`
Related atom: `atomic/02-02-horizon-mesa-hlod-data.md`
Related simulation: `simulations/02-02-horizon-mesa-hlod-data-simulation.md`

## Intention

Harden the serializable source data and mask/anchor fixture for far mesa proxy cells, skyline continuity, and cheap distant terrain identity so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
