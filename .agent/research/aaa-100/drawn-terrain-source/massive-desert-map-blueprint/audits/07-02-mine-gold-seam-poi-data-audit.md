# Mine Gold Seam POI - Data Fixture Hardening Audit

Status: active docs-only
Domain: gameplay / content / world
Generic kit: `n:world:placement-raycast`
GoldRush kit: `n:goldrush:gold-seam-protokits`
Related atom: `atomic/07-02-mine-gold-seam-poi-data.md`
Related simulation: `simulations/07-02-mine-gold-seam-poi-data-simulation.md`

## Intention

Harden the serializable source data and mask/anchor fixture for source-anchored mine mouth, gold seams, mining affordances, and risk reward placement so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
