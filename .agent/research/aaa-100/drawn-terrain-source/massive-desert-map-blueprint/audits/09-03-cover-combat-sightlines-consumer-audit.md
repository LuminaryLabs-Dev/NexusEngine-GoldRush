# Cover Combat Sightlines - Consumer Contract Hardening Audit

Status: active docs-only
Domain: combat / world / camera
Generic kit: `n:world:line-of-sight`
GoldRush kit: `n:goldrush:combat-route-guidance`
Related atom: `atomic/09-03-cover-combat-sightlines-consumer.md`
Related simulation: `simulations/09-03-cover-combat-sightlines-consumer-simulation.md`

## Intention

Harden the kit consumers, public events, and snapshots for cover pockets, sightline breaks, threat route readability, and camera-safe combat lanes so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
