# Extraction Depot Cashout - Intent Hardening Audit

Status: active docs-only
Domain: gameplay / world / presentation
Generic kit: `n:world:zone-mask`
GoldRush kit: `n:goldrush:cashout-sites`
Related atom: `atomic/08-01-extraction-depot-cashout-intent.md`
Related simulation: `simulations/08-01-extraction-depot-cashout-intent-simulation.md`

## Intention

Harden the player-facing purpose and ownership decision for cashout depot landmark, reachable deposit route, contest space, and results receipts so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
