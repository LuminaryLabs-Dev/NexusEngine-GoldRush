# Cover Combat Sightlines - Intent Hardening Audit

Status: active docs-only
Domain: combat / world / camera
Generic kit: `n:world:line-of-sight`
GoldRush kit: `n:goldrush:combat-route-guidance`
Related atom: `atomic/09-01-cover-combat-sightlines-intent.md`
Related simulation: `simulations/09-01-cover-combat-sightlines-intent-simulation.md`

## Intention

Harden the player-facing purpose and ownership decision for cover pockets, sightline breaks, threat route readability, and camera-safe combat lanes so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
