# Extraction Depot Cashout - Proof Gate Hardening Audit

Status: active docs-only
Domain: gameplay / world / presentation
Generic kit: `n:world:zone-mask`
GoldRush kit: `n:goldrush:cashout-sites`
Related atom: `atomic/08-04-extraction-depot-cashout-proof.md`
Related simulation: `simulations/08-04-extraction-depot-cashout-proof-simulation.md`

## Intention

Harden the validator, screenshot, video, and deploy acceptance gate for cashout depot landmark, reachable deposit route, contest space, and results receipts so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
