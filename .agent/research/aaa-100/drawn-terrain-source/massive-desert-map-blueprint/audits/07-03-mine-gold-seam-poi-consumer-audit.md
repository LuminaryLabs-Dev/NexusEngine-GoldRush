# Mine Gold Seam POI - Consumer Contract Hardening Audit

Status: active docs-only
Domain: gameplay / content / world
Generic kit: `n:world:placement-raycast`
GoldRush kit: `n:goldrush:gold-seam-protokits`
Related atom: `atomic/07-03-mine-gold-seam-poi-consumer.md`
Related simulation: `simulations/07-03-mine-gold-seam-poi-consumer-simulation.md`

## Intention

Harden the kit consumers, public events, and snapshots for source-anchored mine mouth, gold seams, mining affordances, and risk reward placement so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
