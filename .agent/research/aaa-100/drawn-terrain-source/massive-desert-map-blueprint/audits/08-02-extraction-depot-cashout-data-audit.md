# Extraction Depot Cashout - Data Fixture Hardening Audit

Status: active docs-only
Domain: gameplay / world / presentation
Generic kit: `n:world:zone-mask`
GoldRush kit: `n:goldrush:cashout-sites`
Related atom: `atomic/08-02-extraction-depot-cashout-data.md`
Related simulation: `simulations/08-02-extraction-depot-cashout-data-simulation.md`

## Intention

Harden the serializable source data and mask/anchor fixture for cashout depot landmark, reachable deposit route, contest space, and results receipts so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
