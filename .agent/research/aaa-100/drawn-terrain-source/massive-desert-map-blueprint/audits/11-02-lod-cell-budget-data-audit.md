# LOD Cell Budget - Data Fixture Hardening Audit

Status: active docs-only
Domain: performance / render / network
Generic kit: `n:world:terrain-chunks`
GoldRush kit: `n:goldrush:gold-field-lod`
Related atom: `atomic/11-02-lod-cell-budget-data.md`
Related simulation: `simulations/11-02-lod-cell-budget-data-simulation.md`

## Intention

Harden the serializable source data and mask/anchor fixture for near/mid/far/hidden cell budgets, LOD hysteresis, and source-revision cell proof so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
