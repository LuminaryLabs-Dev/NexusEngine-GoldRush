# Zone Pressure Final Rush - Consumer Contract Hardening Audit

Status: active docs-only
Domain: battle royale / gameplay / world
Generic kit: `n:world:zone-mask`
GoldRush kit: `n:goldrush:final-rush-pressure`
Related atom: `atomic/10-03-zone-pressure-final-rush-consumer.md`
Related simulation: `simulations/10-03-zone-pressure-final-rush-consumer-simulation.md`

## Intention

Harden the kit consumers, public events, and snapshots for battle-royale pressure corridors, late route choices, and fair closure lanes so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
