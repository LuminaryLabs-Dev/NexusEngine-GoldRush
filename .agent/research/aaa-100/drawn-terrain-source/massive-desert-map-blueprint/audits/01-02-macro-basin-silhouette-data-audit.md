# Macro Basin Silhouette - Data Fixture Hardening Audit

Status: active docs-only
Domain: world / art direction
Generic kit: `n:world:authored-terrain-mesh`
GoldRush kit: `n:goldrush:desert-world-map`
Related atom: `atomic/01-02-macro-basin-silhouette-data.md`
Related simulation: `simulations/01-02-macro-basin-silhouette-data-simulation.md`

## Intention

Harden the serializable source data and mask/anchor fixture for basin silhouette, horizon scale, central blocker read, and first map identity so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
