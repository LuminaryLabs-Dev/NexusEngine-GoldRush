# Horizon Mesa HLOD - Consumer Contract Hardening Audit

Status: active docs-only
Domain: render / performance / world
Generic kit: `n:world:terrain-chunks`
GoldRush kit: `n:goldrush:gold-field-lod`
Related atom: `atomic/02-03-horizon-mesa-hlod-consumer.md`
Related simulation: `simulations/02-03-horizon-mesa-hlod-consumer-simulation.md`

## Intention

Harden the kit consumers, public events, and snapshots for far mesa proxy cells, skyline continuity, and cheap distant terrain identity so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
