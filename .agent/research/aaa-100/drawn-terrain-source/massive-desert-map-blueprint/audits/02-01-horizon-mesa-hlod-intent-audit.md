# Horizon Mesa HLOD - Intent Hardening Audit

Status: active docs-only
Domain: render / performance / world
Generic kit: `n:world:terrain-chunks`
GoldRush kit: `n:goldrush:gold-field-lod`
Related atom: `atomic/02-01-horizon-mesa-hlod-intent.md`
Related simulation: `simulations/02-01-horizon-mesa-hlod-intent-simulation.md`

## Intention

Harden the player-facing purpose and ownership decision for far mesa proxy cells, skyline continuity, and cheap distant terrain identity so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
