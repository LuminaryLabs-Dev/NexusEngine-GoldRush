# Cover Combat Sightlines - Proof Gate Hardening Audit

Status: active docs-only
Domain: combat / world / camera
Generic kit: `n:world:line-of-sight`
GoldRush kit: `n:goldrush:combat-route-guidance`
Related atom: `atomic/09-04-cover-combat-sightlines-proof.md`
Related simulation: `simulations/09-04-cover-combat-sightlines-proof-simulation.md`

## Intention

Harden the validator, screenshot, video, and deploy acceptance gate for cover pockets, sightline breaks, threat route readability, and camera-safe combat lanes so future implementation advances GoldRush toward a high-fidelity wild-west extraction battle royale instead of creating another narrow terrain proof.
