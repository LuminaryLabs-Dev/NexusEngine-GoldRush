# Macro Basin Silhouette - Intent Implementation Simulation
...
Simulate how future implementation would handle the player-facing purpose and ownership decision for basin silhouette, horizon scale, central blocker read, and first map identity without touching runtime code in this docs-only phase.
