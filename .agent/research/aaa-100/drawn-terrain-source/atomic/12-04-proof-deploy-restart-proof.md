# Proof Deploy And Restart - Proof Gate
...
- atom id: 12-04-proof-deploy-restart-proof
- source revision
- domain owner
- consumer readiness
- validation state
...
Stop if proof cannot detect local proof and public proof describe different map states.
