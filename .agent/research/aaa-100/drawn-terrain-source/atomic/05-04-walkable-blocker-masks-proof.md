# Walkable And Blocker Masks - Proof Gate
...
- atom id: 05-04-walkable-blocker-masks-proof
- source revision
- domain owner
- consumer readiness
- validation state
...
Stop if proof cannot detect player floats, sinks, or walks through mountains.
