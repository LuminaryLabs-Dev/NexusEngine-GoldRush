...
- atom id: 03-01-heightfield-form-intent
- source revision
- domain owner
- consumer readiness
- validation state
...
Stop if heightfield form is described as visual polish instead of a source-owned gameplay concern.
