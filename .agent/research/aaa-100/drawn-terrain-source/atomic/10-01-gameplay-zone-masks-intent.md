...
- atom id: 10-01-gameplay-zone-masks-intent
- source revision
- domain owner
- consumer readiness
- validation state
...
Stop if gameplay zone masks is described as visual polish instead of a source-owned gameplay concern.
