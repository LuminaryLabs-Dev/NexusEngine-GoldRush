...
- atom id: 08-01-placement-anchors-intent
- source revision
- domain owner
- consumer readiness
- validation state
...
Stop if placement anchors is described as visual polish instead of a source-owned gameplay concern.
