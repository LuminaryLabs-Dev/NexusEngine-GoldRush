...
- atom id: 02-01-coordinate-scale-intent
- source revision
- domain owner
- consumer readiness
- validation state
...
Stop if coordinate and scale is described as visual polish instead of a source-owned gameplay concern.
