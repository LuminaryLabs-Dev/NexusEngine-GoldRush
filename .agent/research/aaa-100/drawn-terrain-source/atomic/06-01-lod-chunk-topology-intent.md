...
- atom id: 06-01-lod-chunk-topology-intent
- source revision
- domain owner
- consumer readiness
- validation state
...
Stop if lod chunk topology is described as visual polish instead of a source-owned gameplay concern.
