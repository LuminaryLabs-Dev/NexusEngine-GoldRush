# Material And Biome Masks - Data Fixture
...
- atom id: 04-02-material-biome-masks-data
- source revision
- domain owner
- consumer readiness
- validation state
...
Stop if the fixture omits sand, clay, rock, wash, trail, mine, town material masks.
