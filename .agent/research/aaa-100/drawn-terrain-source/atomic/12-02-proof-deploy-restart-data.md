# Proof Deploy And Restart - Data Fixture
...
- atom id: 12-02-proof-deploy-restart-data
- source revision
- domain owner
- consumer readiness
- validation state
...
Stop if the fixture omits proof fixture id, source revision, local/public result, restart receipt.
