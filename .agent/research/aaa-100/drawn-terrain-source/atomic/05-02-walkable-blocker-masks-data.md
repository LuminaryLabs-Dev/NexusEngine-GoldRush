# Walkable And Blocker Masks - Data Fixture
...
- atom id: 05-02-walkable-blocker-masks-data
- source revision
- domain owner
- consumer readiness
- validation state
...
Stop if the fixture omits walkable mask, slope limits, blocker mask, step zones.
