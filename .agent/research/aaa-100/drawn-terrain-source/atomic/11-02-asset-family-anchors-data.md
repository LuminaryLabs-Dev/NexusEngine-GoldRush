# Asset Family Anchors - Data Fixture

Status: planned docs-only
Parent: drawn terrain source
Domain: content/render/world
Candidate generic kit: n:render:micro-object-instancing
Candidate GoldRush kit: n:goldrush:desert-asset-family-protokits
...
This atom prevents primitive placeholders persist as final content from surviving into the terrain implementation. It keeps the massive desert map source useful to render, physics, gameplay, staging, proof, and future 60-player room orchestration.

## Data Seed

asset family, source mask, form role, placement batch, interaction hooks.
...
- atom id: 11-02-asset-family-anchors-data
- source revision
- domain owner
- consumer readiness
- validation state
...
Stop if the fixture omits asset family, source mask, form role, placement batch, interaction hooks.
