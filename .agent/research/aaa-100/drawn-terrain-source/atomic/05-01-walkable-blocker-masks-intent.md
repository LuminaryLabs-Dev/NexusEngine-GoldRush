# Walkable And Blocker Masks - Intent
...
This atom prevents player floats, sinks, or walks through mountains from surviving into the terrain implementation. It keeps the massive desert map source useful to render, physics, gameplay, staging, proof, and future 60-player room orchestration.

## Data Seed

walkable mask, slope limits, blocker mask, step zones.
...
- atom id: 05-01-walkable-blocker-masks-intent
- source revision
- domain owner
- consumer readiness
- validation state
...
Stop if walkable and blocker masks is described as visual polish instead of a source-owned gameplay concern.
