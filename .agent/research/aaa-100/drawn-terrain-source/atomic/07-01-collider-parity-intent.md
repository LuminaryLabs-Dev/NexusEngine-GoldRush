...
- atom id: 07-01-collider-parity-intent
- source revision
- domain owner
- consumer readiness
- validation state
...
Stop if collider parity is described as visual polish instead of a source-owned gameplay concern.
