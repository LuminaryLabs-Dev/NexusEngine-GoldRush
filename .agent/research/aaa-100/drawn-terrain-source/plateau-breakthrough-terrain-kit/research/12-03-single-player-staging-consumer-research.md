# Single Player Staging Consumer Research
...
What external or project-local evidence would make single-player-staging / consumer strong enough for a production terrain source pass?
