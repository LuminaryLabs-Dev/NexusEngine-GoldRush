# Sixty Player Scale Intent Research
...
What external or project-local evidence would make sixty-player-scale / intent strong enough for a production terrain source pass?
