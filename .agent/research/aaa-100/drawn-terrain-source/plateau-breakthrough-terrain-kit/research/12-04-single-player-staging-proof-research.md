# Single Player Staging Proof Research
...
What external or project-local evidence would make single-player-staging / proof strong enough for a production terrain source pass?
