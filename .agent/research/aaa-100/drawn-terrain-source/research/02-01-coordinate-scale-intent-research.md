# Research - Coordinate And Scale - Intent

Status: planned docs-only
Parent atom: 02-01-coordinate-scale-intent

## Research Question

What source, domain, data, proof, and edge-case knowledge is needed before implementing coordinate and scale - intent?
