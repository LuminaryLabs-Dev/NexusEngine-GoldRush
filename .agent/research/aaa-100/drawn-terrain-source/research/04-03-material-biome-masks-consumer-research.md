# Research - Material And Biome Masks - Consumer Contract

Status: planned docs-only
Parent atom: 04-03-material-biome-masks-consumer

## Research Question

What source, domain, data, proof, and edge-case knowledge is needed before implementing material and biome masks - consumer contract?
...
Material And Biome Masks belongs to world/render/art. It should become source-owned data consumed by kits, not hardcoded rendering behavior.

## Data And Proof Need

The minimum data is sand, clay, rock, wash, trail, mine, town material masks. Proof must show that this atom can survive restart, source revision changes, and local/public validation without relying on debug coordinates.
