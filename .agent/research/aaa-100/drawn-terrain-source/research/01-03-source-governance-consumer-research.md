# Research - Source Governance - Consumer Contract

Status: planned docs-only
Parent atom: 01-03-source-governance-consumer

## Research Question

What source, domain, data, proof, and edge-case knowledge is needed before implementing source governance - consumer contract?
...
Source Governance belongs to governance/world. It should become source-owned data consumed by kits, not hardcoded rendering behavior.

## Data And Proof Need

The minimum data is source id, revision hash, ownership state, approval state. Proof must show that this atom can survive restart, source revision changes, and local/public validation without relying on debug coordinates.
