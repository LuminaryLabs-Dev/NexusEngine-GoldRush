# Research - LOD Chunk Topology - Intent

Status: planned docs-only
Parent atom: 06-01-lod-chunk-topology-intent

## Research Question

What source, domain, data, proof, and edge-case knowledge is needed before implementing lod chunk topology - intent?
