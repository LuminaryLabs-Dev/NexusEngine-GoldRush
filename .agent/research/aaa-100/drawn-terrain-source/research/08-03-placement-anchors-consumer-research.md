# Research - Placement Anchors - Consumer Contract

Status: planned docs-only
Parent atom: 08-03-placement-anchors-consumer

## Research Question

What source, domain, data, proof, and edge-case knowledge is needed before implementing placement anchors - consumer contract?
...
Placement Anchors belongs to world/content. It should become source-owned data consumed by kits, not hardcoded rendering behavior.

## Data And Proof Need

The minimum data is anchor ids, placement masks, downward hits, slope filters. Proof must show that this atom can survive restart, source revision changes, and local/public validation without relying on debug coordinates.
