# Research - Placement Anchors - Intent

Status: planned docs-only
Parent atom: 08-01-placement-anchors-intent

## Research Question

What source, domain, data, proof, and edge-case knowledge is needed before implementing placement anchors - intent?
