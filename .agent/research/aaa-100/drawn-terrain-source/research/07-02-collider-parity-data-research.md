# Research - Collider Parity - Data Fixture

Status: planned docs-only
Parent atom: 07-02-collider-parity-data

## Research Question

What source, domain, data, proof, and edge-case knowledge is needed before implementing collider parity - data fixture?
