# Research - Coordinate And Scale - Consumer Contract

Status: planned docs-only
Parent atom: 02-03-coordinate-scale-consumer

## Research Question

What source, domain, data, proof, and edge-case knowledge is needed before implementing coordinate and scale - consumer contract?
