# Research - Route Rail And Wash Network - Consumer Contract

Status: planned docs-only
Parent atom: 09-03-route-rail-wash-network-consumer

## Research Question

What source, domain, data, proof, and edge-case knowledge is needed before implementing route rail and wash network - consumer contract?
...
Route Rail And Wash Network belongs to world/control/gameplay. It should become source-owned data consumed by kits, not hardcoded rendering behavior.

## Data And Proof Need

The minimum data is route graph, rail spline, wash path, travel costs, visibility hints. Proof must show that this atom can survive restart, source revision changes, and local/public validation without relying on debug coordinates.
