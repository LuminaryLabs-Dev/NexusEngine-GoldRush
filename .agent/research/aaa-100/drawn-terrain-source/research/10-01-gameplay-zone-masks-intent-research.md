# Research - Gameplay Zone Masks - Intent

Status: planned docs-only
Parent atom: 10-01-gameplay-zone-masks-intent

## Research Question

What source, domain, data, proof, and edge-case knowledge is needed before implementing gameplay zone masks - intent?
