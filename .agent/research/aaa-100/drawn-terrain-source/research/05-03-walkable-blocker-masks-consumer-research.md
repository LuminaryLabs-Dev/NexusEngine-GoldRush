# Research - Walkable And Blocker Masks - Consumer Contract

Status: planned docs-only
Parent atom: 05-03-walkable-blocker-masks-consumer

## Research Question

What source, domain, data, proof, and edge-case knowledge is needed before implementing walkable and blocker masks - consumer contract?
...
Walkable And Blocker Masks belongs to world/physics/control. It should become source-owned data consumed by kits, not hardcoded rendering behavior.

## Data And Proof Need

The minimum data is walkable mask, slope limits, blocker mask, step zones. Proof must show that this atom can survive restart, source revision changes, and local/public validation without relying on debug coordinates.
