# Research - Heightfield Form - Intent

Status: planned docs-only
Parent atom: 03-01-heightfield-form-intent

## Research Question

What source, domain, data, proof, and edge-case knowledge is needed before implementing heightfield form - intent?
