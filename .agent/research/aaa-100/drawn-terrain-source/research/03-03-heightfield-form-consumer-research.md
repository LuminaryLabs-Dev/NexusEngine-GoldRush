# Research - Heightfield Form - Consumer Contract

Status: planned docs-only
Parent atom: 03-03-heightfield-form-consumer

## Research Question

What source, domain, data, proof, and edge-case knowledge is needed before implementing heightfield form - consumer contract?
...
Heightfield Form belongs to world/terrain. It should become source-owned data consumed by kits, not hardcoded rendering behavior.

## Data And Proof Need

The minimum data is height samples, normals, slope, ridge/wash forms. Proof must show that this atom can survive restart, source revision changes, and local/public validation without relying on debug coordinates.
