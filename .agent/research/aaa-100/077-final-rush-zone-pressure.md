...
## Question
What has to be researched, specified, and proven so final rush/zone pressure can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Domain Owner
`battle royale` owns this packet until implementation splits it into more specific kit or feature packets.

## Kit Impact
n:network:room-partitions, party-room, combat-pressure, match lifecycle, and staging bot kits

## Atomic Substeps
- Shrink/collapse rule
- safe zones
- extraction lockouts
- finale
