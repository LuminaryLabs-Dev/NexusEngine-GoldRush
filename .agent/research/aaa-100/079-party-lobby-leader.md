...
## Question
What has to be researched, specified, and proven so party lobby and leader can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Domain Owner
`network/UX` owns this packet until implementation splits it into more specific kit or feature packets.
