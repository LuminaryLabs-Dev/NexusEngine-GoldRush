...
## Question
What has to be researched, specified, and proven so risk register can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Atomic Substeps
- Rank asset, network, performance, UX, deploy, licensing risks
