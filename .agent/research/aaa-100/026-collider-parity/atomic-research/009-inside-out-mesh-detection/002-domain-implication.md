# 026.009 Inside Out Mesh Detection - Domain Implication

Status: research-planned
Parent: 026 Collider parity
Atomic: 026.009 Inside Out Mesh Detection
Domain: physics
Owning kit candidate: `n:physics:terrain-collider-parity`

## Domain Implication

Detect downward-wound terrain faces, inverted normals, and one-sided collision mismatch before browser proof.
