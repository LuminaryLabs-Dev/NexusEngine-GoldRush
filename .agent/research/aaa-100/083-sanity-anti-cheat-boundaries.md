# 083 Sanity/anti-cheat boundaries
...
## Question
What has to be researched, specified, and proven so sanity/anti-cheat boundaries can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Domain Owner
`network/security` owns this packet until implementation splits it into more specific kit or feature packets.

## Kit Impact
n:network:room-partitions, party-room, combat-pressure, match lifecycle, and staging bot kits

## Atomic Substeps
- Validate impossible moves
- impossible gold
- rate limits
- receipt auth
...
Public play is not trivial to spoof
