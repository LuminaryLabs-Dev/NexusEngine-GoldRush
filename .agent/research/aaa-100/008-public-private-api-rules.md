...
## Question
What has to be researched, specified, and proven so public/private api rules can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
Public API does not become config sprawl
