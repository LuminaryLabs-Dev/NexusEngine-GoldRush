...
## Question
What has to be researched, specified, and proven so extraction scan can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Atomic Substeps
- Compare extraction reward loops
- define bounty/gold pressure
...
Gold value creates risk decisions
