...
## Question
What has to be researched, specified, and proven so lod ring contract can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Domain Owner
`world/render` owns this packet until implementation splits it into more specific kit or feature packets.

## Kit Impact
n:goldrush:authored-desert-map plus terrain, collider, placement, route, and extraction-site kits

## Atomic Substeps
- Define near/mid/far rings
- set chunk sizes
- set swap thresholds
...
No visible popping at normal speed
...
- Folder: .agent/research/aaa-100/024-lod-ring-contract/
- Index: .agent/research/aaa-100/024-lod-ring-contract/README.md
