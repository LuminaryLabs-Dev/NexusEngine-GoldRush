...
## Question
What has to be researched, specified, and proven so player mesh integration can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Domain Owner
`character` owns this packet until implementation splits it into more specific kit or feature packets.

## Kit Impact
n:control:third-person-camera, n:control:character-movement, n:animation:state, and GoldRush player/presentation kits

## Atomic Substeps
- Select approved mesh
- scale
- pivot
- shadow
- material
...
Player no longer reads as placeholder
