...
## Question
What has to be researched, specified, and proven so biome/material masks can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Domain Owner
`art/world` owns this packet until implementation splits it into more specific kit or feature packets.

## Kit Impact
n:goldrush:authored-desert-map plus terrain, collider, placement, route, and extraction-site kits

## Atomic Substeps
- Map sand, clay, rock, trail, gold, town, rail surfaces
