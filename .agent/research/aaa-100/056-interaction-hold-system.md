...
## Question
What has to be researched, specified, and proven so interaction hold system can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Domain Owner
`gameplay` owns this packet until implementation splits it into more specific kit or feature packets.

## Kit Impact
n:gameplay:interaction-hold, cargo, extraction, receipts, scoring, and GoldRush player-action kits

## Atomic Substeps
- Normalize hold start/update/cancel/complete
- expose progress
...
Mining/extraction feel consistent
