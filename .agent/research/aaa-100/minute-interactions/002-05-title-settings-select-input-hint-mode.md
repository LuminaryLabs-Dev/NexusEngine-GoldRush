# Select Input Hint Mode

Status: active docs-only

Interaction ID: 002-05
Family: Title Settings
Domain: UX/audio/accessibility
Owner: n:audio:cue-state plus n:goldrush:settings
...
Event: goldrushMinuteInteraction00205Observed
...
- research/002-05-title-settings-select-input-hint-mode-research.md
