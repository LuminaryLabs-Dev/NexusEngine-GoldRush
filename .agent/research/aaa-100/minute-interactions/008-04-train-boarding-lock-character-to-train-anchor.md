# Lock Character To Train Anchor

Status: active docs-only

Interaction ID: 008-04
Family: Train Boarding
Domain: control/scene/network
Owner: n:goldrush:train-loading plus n:control:character-movement
...
Event: goldrushMinuteInteraction00804Observed
...
- research/008-04-train-boarding-lock-character-to-train-anchor-research.md
