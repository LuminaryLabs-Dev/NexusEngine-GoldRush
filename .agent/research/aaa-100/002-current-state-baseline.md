...
## Question
What has to be researched, specified, and proven so current state baseline can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
Compare every new pass against baseline
