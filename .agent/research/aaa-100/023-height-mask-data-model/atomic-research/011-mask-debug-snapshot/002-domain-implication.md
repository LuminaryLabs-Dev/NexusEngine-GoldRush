# 023.011 Mask Debug Snapshot - Domain Implication

Status: research-planned
Parent: 023 Height and mask data model
Atomic: 023.011 Mask Debug Snapshot
Domain: world
Owning kit candidate: `n:world:terrain-heightfield`

## Domain Implication

Expose serializable mask summaries so proofs can compare visible objects to source data.
