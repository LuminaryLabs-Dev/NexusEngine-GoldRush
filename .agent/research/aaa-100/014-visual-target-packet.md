...
## Question
What has to be researched, specified, and proven so visual target packet can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
## Domain Owner
`art direction` owns this packet until implementation splits it into more specific kit or feature packets.

## Kit Impact
research packets and future kit gap definitions

## Atomic Substeps
- Define toon-shaded western look
- set reference rules
...
Prototype visuals cannot pass as final
