# Player Gear And Character Readability - Protokit Contract
...
define the local GoldRush protokit contract, public data, events, and snapshot for the player gear and character readability family.
