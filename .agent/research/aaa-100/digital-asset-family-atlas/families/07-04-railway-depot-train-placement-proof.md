# Railway Depot And Train - Placement And Proof

Status: planned docs-only
Parent: digital asset family atlas
Domain: scene/content/extraction
Candidate GoldRush kit: n:goldrush:railway-protokits
Terrain source relationship: rail, extraction, route masks

## Atomic Goal

define terrain-mask placement, collider/interaction rules, and human-view proof for the railway depot and train family.
...
rail bed, ties, track, depot platform, signal post, train stop, cart.
...
- family id: railway-depot-train
- kit: n:goldrush:railway-protokits
