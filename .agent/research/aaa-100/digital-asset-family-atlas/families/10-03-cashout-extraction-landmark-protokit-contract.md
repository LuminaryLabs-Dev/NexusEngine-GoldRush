# Cashout Extraction Landmark - Protokit Contract
...
define the local GoldRush protokit contract, public data, events, and snapshot for the cashout extraction landmark family.
