# Combat Cover Barricade - Protokit Contract
...
define the local GoldRush protokit contract, public data, events, and snapshot for the combat cover barricade family.
