# Loot Cargo And Tools - Placement And Proof

Status: planned docs-only
Parent: digital asset family atlas
Domain: gameplay/content/interaction
Candidate GoldRush kit: n:goldrush:cargo-tool-protokits
Terrain source relationship: mine, town, route, extraction masks

## Atomic Goal

define terrain-mask placement, collider/interaction rules, and human-view proof for the loot cargo and tools family.
...
gold bag, pickaxe, shovel, dynamite crate, lockbox, supply sack.
...
- family id: loot-cargo-tools
- kit: n:goldrush:cargo-tool-protokits
