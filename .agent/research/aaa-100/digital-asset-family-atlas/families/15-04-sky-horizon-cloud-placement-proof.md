# Sky Horizon And Cloud - Placement And Proof

Status: planned docs-only
Parent: digital asset family atlas
Domain: render/world/atmosphere
Candidate GoldRush kit: n:goldrush:sky-horizon-protokits
Terrain source relationship: horizon, time, condition, biome masks

## Atomic Goal

define terrain-mask placement, collider/interaction rules, and human-view proof for the sky horizon and cloud family.
...
painted horizon, 2D cloud planes, dust haze, sun band, distant mesas.
...
- family id: sky-horizon-cloud
- kit: n:goldrush:sky-horizon-protokits
