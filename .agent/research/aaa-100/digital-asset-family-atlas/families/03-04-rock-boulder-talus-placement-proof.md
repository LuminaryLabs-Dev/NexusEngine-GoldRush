# Rock Boulder And Talus - Placement And Proof

Status: planned docs-only
Parent: digital asset family atlas
Domain: content/world/combat
Candidate GoldRush kit: n:goldrush:desert-rock-protokits
Terrain source relationship: cover, material, slope, blocker masks

## Atomic Goal

define terrain-mask placement, collider/interaction rules, and human-view proof for the rock boulder and talus family.
...
pebbles, boulders, talus fans, low cover rocks, landmark stones.
...
- family id: rock-boulder-talus
- kit: n:goldrush:desert-rock-protokits
