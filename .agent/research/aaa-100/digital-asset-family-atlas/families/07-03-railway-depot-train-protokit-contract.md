# Railway Depot And Train - Protokit Contract
...
define the local GoldRush protokit contract, public data, events, and snapshot for the railway depot and train family.
