# Cactus Scrub And Plant - Protokit Contract
...
define the local GoldRush protokit contract, public data, events, and snapshot for the cactus scrub and plant family.
