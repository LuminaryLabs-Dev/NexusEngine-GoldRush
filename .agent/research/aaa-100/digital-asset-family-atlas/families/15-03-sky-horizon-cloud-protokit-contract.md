# Sky Horizon And Cloud - Protokit Contract
...
define the local GoldRush protokit contract, public data, events, and snapshot for the sky horizon and cloud family.
