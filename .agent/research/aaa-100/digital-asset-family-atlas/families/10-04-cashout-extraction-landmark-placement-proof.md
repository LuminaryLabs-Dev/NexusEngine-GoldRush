# Cashout Extraction Landmark - Placement And Proof

Status: planned docs-only
Parent: digital asset family atlas
Domain: gameplay/content/extraction
Candidate GoldRush kit: n:goldrush:cashout-setpiece-protokits
Terrain source relationship: extraction, route, sightline masks

## Atomic Goal

define terrain-mask placement, collider/interaction rules, and human-view proof for the cashout extraction landmark family.
...
cashout beacon, depot bell, smoke column, platform, flag, deposit chest.
...
- family id: cashout-extraction-landmark
- kit: n:goldrush:cashout-setpiece-protokits
