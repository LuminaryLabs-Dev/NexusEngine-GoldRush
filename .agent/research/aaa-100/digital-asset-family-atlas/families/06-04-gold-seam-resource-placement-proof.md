# Gold Seam Resource - Placement And Proof

Status: planned docs-only
Parent: digital asset family atlas
Domain: gameplay/content/render
Candidate GoldRush kit: n:goldrush:gold-seam-protokits
Terrain source relationship: gold, mine, interaction masks

## Atomic Goal

define terrain-mask placement, collider/interaction rules, and human-view proof for the gold seam resource family.
...
ore seam, nugget cluster, claim marker, glitter cue, broken rock face.
...
- family id: gold-seam-resource
- kit: n:goldrush:gold-seam-protokits
