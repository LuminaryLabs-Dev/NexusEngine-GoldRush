# Cactus Scrub And Plant - Placement And Proof

Status: planned docs-only
Parent: digital asset family atlas
Domain: content/world/readability
Candidate GoldRush kit: n:goldrush:desert-plant-protokits
Terrain source relationship: biome, route, visibility masks

## Atomic Goal

define terrain-mask placement, collider/interaction rules, and human-view proof for the cactus scrub and plant family.
...
saguaro silhouettes, barrel cactus, scrub clumps, dead branches, grass tufts.
...
- family id: cactus-scrub-plant
- kit: n:goldrush:desert-plant-protokits
