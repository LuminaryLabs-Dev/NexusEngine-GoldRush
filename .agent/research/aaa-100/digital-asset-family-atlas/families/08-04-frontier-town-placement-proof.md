# Frontier Town - Placement And Proof

Status: planned docs-only
Parent: digital asset family atlas
Domain: content/world/social-cover
Candidate GoldRush kit: n:goldrush:frontier-town-protokits
Terrain source relationship: town, route, cover masks

## Atomic Goal

define terrain-mask placement, collider/interaction rules, and human-view proof for the frontier town family.
...
false fronts, porch rails, crates, barrels, hitching posts, street signs.
...
- family id: frontier-town
- kit: n:goldrush:frontier-town-protokits
