# VFX SFX And Diegetic Cues - Placement And Proof

Status: planned docs-only
Parent: digital asset family atlas
Domain: presentation/audio/render
Candidate GoldRush kit: n:goldrush:feedback-cue-protokits
Terrain source relationship: interaction, gold, extraction, combat state

## Atomic Goal

define terrain-mask placement, collider/interaction rules, and human-view proof for the vfx sfx and diegetic cues family.
...
dust puffs, glints, bell hits, pickup sparks, smoke, danger pings.
...
- family id: vfx-sfx-diegetic-cues
- kit: n:goldrush:feedback-cue-protokits
