# Mine Entrance Site - Placement And Proof

Status: planned docs-only
Parent: digital asset family atlas
Domain: content/gameplay/world
Candidate GoldRush kit: n:goldrush:mine-site-protokits
Terrain source relationship: mine, gold, rail, route masks

## Atomic Goal

define terrain-mask placement, collider/interaction rules, and human-view proof for the mine entrance site family.
...
tunnel mouth, timber supports, lanterns, cart rails, tailings pile, warning sign.
...
- family id: mine-entrance-site
- kit: n:goldrush:mine-site-protokits
