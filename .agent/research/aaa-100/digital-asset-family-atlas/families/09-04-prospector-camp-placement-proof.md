# Prospector Camp - Placement And Proof

Status: planned docs-only
Parent: digital asset family atlas
Domain: content/world/staging
Candidate GoldRush kit: n:goldrush:prospector-camp-protokits
Terrain source relationship: camp, route, biome masks

## Atomic Goal

define terrain-mask placement, collider/interaction rules, and human-view proof for the prospector camp family.
...
tents, bedrolls, fire ring, crates, cook pot, tool rack.
...
- family id: prospector-camp
- kit: n:goldrush:prospector-camp-protokits
