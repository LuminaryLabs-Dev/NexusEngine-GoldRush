# Player Gear And Character Readability - Placement And Proof

Status: planned docs-only
Parent: digital asset family atlas
Domain: character/content/render
Candidate GoldRush kit: n:goldrush:prospector-gear-protokits
Terrain source relationship: spawn, lobby, gameplay state

## Atomic Goal

define terrain-mask placement, collider/interaction rules, and human-view proof for the player gear and character readability family.
...
hat, coat, satchel, boots, skeleton gear, carried gold, weapon silhouette.
...
- family id: player-gear-character-readability
- kit: n:goldrush:prospector-gear-protokits
