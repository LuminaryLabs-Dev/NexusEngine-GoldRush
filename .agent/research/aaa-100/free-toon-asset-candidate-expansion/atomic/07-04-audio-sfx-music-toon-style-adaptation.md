# Audio SFX Music - Toon Style Adaptation
...
define how the asset will match GoldRush toon western palette, scale, silhouette, and material roles for Audio SFX Music.
...
- `audio-sfx-music.toon-style-adaptation.checked`
- `audio-sfx-music.toon-style-adaptation.blocked`
- `audio-sfx-music.toon-style-adaptation.readyForNextGate`

## Snapshot Seed

`{ candidateSet: 'audio-sfx-music', gate: 'toon-style-adaptation', state: 'planned', runtimePromotion: false }`
