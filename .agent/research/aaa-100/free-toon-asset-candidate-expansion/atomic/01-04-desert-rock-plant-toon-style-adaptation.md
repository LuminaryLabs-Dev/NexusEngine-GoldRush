# Desert Rock And Plant - Toon Style Adaptation
...
define how the asset will match GoldRush toon western palette, scale, silhouette, and material roles for Desert Rock And Plant.
...
- `desert-rock-plant.toon-style-adaptation.checked`
- `desert-rock-plant.toon-style-adaptation.blocked`
- `desert-rock-plant.toon-style-adaptation.readyForNextGate`

## Snapshot Seed

`{ candidateSet: 'desert-rock-plant', gate: 'toon-style-adaptation', state: 'planned', runtimePromotion: false }`
