# Rail Train Loading Yard - Toon Style Adaptation
...
define how the asset will match GoldRush toon western palette, scale, silhouette, and material roles for Rail Train Loading Yard.
...
- `rail-train-loading-yard.toon-style-adaptation.checked`
- `rail-train-loading-yard.toon-style-adaptation.blocked`
- `rail-train-loading-yard.toon-style-adaptation.readyForNextGate`

## Snapshot Seed

`{ candidateSet: 'rail-train-loading-yard', gate: 'toon-style-adaptation', state: 'planned', runtimePromotion: false }`
