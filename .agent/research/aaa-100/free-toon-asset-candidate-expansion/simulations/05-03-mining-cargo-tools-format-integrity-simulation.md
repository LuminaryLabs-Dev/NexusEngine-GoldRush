# Mining Cargo Tools - Format Integrity Simulation
...
Simulate what implementation would look like for format integrity in the Mining Cargo Tools candidate set.
