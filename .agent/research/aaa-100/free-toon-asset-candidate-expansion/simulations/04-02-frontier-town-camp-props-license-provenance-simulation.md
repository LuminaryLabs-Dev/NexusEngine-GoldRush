# Frontier Town And Camp Props - License Provenance Simulation
...
Simulate what implementation would look like for license provenance in the Frontier Town And Camp Props candidate set.
