# Prospector Character Animation - Protokit Contract Simulation
...
Simulate what implementation would look like for protokit contract in the Prospector Character Animation candidate set.
