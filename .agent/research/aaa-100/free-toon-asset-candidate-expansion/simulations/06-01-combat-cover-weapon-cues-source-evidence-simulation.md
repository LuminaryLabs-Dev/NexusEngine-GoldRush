# Combat Cover Weapon Cues - Source Evidence Simulation
...
Simulate what implementation would look like for source evidence in the Combat Cover Weapon Cues candidate set.
