# Mining Cargo Tools - Protokit Contract Simulation
...
Simulate what implementation would look like for protokit contract in the Mining Cargo Tools candidate set.
