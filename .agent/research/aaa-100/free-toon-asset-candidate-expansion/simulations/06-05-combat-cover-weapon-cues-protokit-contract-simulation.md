# Combat Cover Weapon Cues - Protokit Contract Simulation
...
Simulate what implementation would look like for protokit contract in the Combat Cover Weapon Cues candidate set.
