# Prospector Character Animation - Source Evidence Simulation
...
Simulate what implementation would look like for source evidence in the Prospector Character Animation candidate set.
