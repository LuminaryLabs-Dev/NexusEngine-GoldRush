# Desert Rock And Plant - Toon Style Adaptation Simulation
...
Simulate what implementation would look like for toon style adaptation in the Desert Rock And Plant candidate set.
...
5. Bind the candidate to n:goldrush:desert-rock-plant-protokits before any renderer, scene, gameplay, or audio consumer can use it.
6. Run the narrow proof: raycast placement plus scale screenshots.
...
The candidate may improve visual or audio quality but fail the gameplay meaning test. For this set, the player problem is: terrain reads empty, flat, and low scale. If the candidate does not make that problem measurably clearer, implementation should stop.
...
- candidate set id: desert-rock-plant
- gate id: toon-style-adaptation
- target kit: n:goldrush:desert-rock-plant-protokits
- candidate source family: Kenney, Quaternius, KayKit
- proof requirement: raycast placement plus scale screenshots
