# Mining Cargo Tools - License Provenance Simulation
...
Simulate what implementation would look like for license provenance in the Mining Cargo Tools candidate set.
