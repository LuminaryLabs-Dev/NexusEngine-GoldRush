# Sky Atmosphere Material - Protokit Contract Simulation
...
Simulate what implementation would look like for protokit contract in the Sky Atmosphere Material candidate set.
