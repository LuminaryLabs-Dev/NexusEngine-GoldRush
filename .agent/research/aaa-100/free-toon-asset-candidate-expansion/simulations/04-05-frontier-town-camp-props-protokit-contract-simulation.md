# Frontier Town And Camp Props - Protokit Contract Simulation
...
Simulate what implementation would look like for protokit contract in the Frontier Town And Camp Props candidate set.
