# Desert Rock And Plant - License Provenance Research
...
Research the source, player-value, and implementation risks for license provenance in the Desert Rock And Plant candidate set.
...
This candidate set addresses: terrain reads empty, flat, and low scale. The atom matters because prove use rights for the exact candidate file or pack before import planning.
