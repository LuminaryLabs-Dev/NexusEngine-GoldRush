# Prospector Character Animation - Proof And Promotion Block Research
...
Research the source, player-value, and implementation risks for proof and promotion block in the Prospector Character Animation candidate set.

## Current Source Signal

Primary source direction: Quaternius modular humanoid or KayKit Adventurers candidate.

## Why This Matters

This candidate set addresses: current rig is too prototype-like for AAA player feel. The atom matters because define local/public proof and keep runtime promotion blocked until approval records exist.
...
- Can it be owned by n:goldrush:prospector-character-protokits?
- Can local and public proof show the player-facing improvement?

## Research Notes

- Quaternius, KayKit are candidates only, not approved runtime assets.
...
- lobby spin and over-shoulder movement proof is the minimum proof shape for this set.
