# Combat Cover Weapon Cues - Proof And Promotion Block Research
...
Research the source, player-value, and implementation risks for proof and promotion block in the Combat Cover Weapon Cues candidate set.
...
This candidate set addresses: ambush pressure lacks readable cover and weapon silhouettes. The atom matters because define local/public proof and keep runtime promotion blocked until approval records exist.
