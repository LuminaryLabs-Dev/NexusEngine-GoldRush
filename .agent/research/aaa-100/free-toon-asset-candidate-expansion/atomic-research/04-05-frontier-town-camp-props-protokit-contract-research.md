# Frontier Town And Camp Props - Protokit Contract Research
...
Research the source, player-value, and implementation risks for protokit contract in the Frontier Town And Camp Props candidate set.

## Current Source Signal

Primary source direction: Quaternius village/prop candidates plus toon adaptation.

## Why This Matters

This candidate set addresses: POIs lack readable western identity. The atom matters because assign the candidate to a local GoldRush kit with domain-owned public data and private implementation rules.
...
- Can it be owned by n:goldrush:frontier-setpiece-protokits?
...
- town shelf and camp route screenshots is the minimum proof shape for this set.
