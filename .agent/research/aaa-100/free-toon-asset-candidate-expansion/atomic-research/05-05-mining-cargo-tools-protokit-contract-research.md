# Mining Cargo Tools - Protokit Contract Research
...
Research the source, player-value, and implementation risks for protokit contract in the Mining Cargo Tools candidate set.

## Current Source Signal

Primary source direction: Quaternius/KayKit tools, crates, ore, and resource candidates.

## Why This Matters

This candidate set addresses: mine, carry, and cashout actions lack tactile object identity. The atom matters because assign the candidate to a local GoldRush kit with domain-owned public data and private implementation rules.
...
- Can it be owned by n:goldrush:mining-cargo-protokits?
...
- mine to carry to cashout human-view proof is the minimum proof shape for this set.
