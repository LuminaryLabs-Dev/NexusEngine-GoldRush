# Sky Atmosphere Material - Toon Style Adaptation Research
...
Research the source, player-value, and implementation risks for toon style adaptation in the Sky Atmosphere Material candidate set.
...
This candidate set addresses: terrain and horizon need a coherent toon mood. The atom matters because define how the asset will match GoldRush toon western palette, scale, silhouette, and material roles.
