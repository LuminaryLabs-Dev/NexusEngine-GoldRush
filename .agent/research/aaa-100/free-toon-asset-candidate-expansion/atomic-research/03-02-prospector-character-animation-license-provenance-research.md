# Prospector Character Animation - License Provenance Research
...
Research the source, player-value, and implementation risks for license provenance in the Prospector Character Animation candidate set.
...
This candidate set addresses: current rig is too prototype-like for AAA player feel. The atom matters because prove use rights for the exact candidate file or pack before import planning.
