# Sky Atmosphere Material - License Provenance Research
...
Research the source, player-value, and implementation risks for license provenance in the Sky Atmosphere Material candidate set.
...
This candidate set addresses: terrain and horizon need a coherent toon mood. The atom matters because prove use rights for the exact candidate file or pack before import planning.
