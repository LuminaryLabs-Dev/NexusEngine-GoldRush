# Combat Cover Weapon Cues - Format Integrity Research
...
Research the source, player-value, and implementation risks for format integrity in the Combat Cover Weapon Cues candidate set.
...
This candidate set addresses: ambush pressure lacks readable cover and weapon silhouettes. The atom matters because confirm the candidate format can enter a browser Three.js pipeline without unsafe conversion surprises.
