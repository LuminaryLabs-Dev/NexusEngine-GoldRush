# Prospector Character Animation - Toon Style Adaptation Research
...
Research the source, player-value, and implementation risks for toon style adaptation in the Prospector Character Animation candidate set.
...
This candidate set addresses: current rig is too prototype-like for AAA player feel. The atom matters because define how the asset will match GoldRush toon western palette, scale, silhouette, and material roles.
