# Combat Cover Weapon Cues - Protokit Contract Research
...
Research the source, player-value, and implementation risks for protokit contract in the Combat Cover Weapon Cues candidate set.

## Current Source Signal

Primary source direction: Quaternius cover/weapon-like silhouettes and Kenney impacts.

## Why This Matters

This candidate set addresses: ambush pressure lacks readable cover and weapon silhouettes. The atom matters because assign the candidate to a local GoldRush kit with domain-owned public data and private implementation rules.
...
- Can it be owned by n:goldrush:combat-cover-protokits?
- Can local and public proof show the player-facing improvement?

## Research Notes

- Quaternius, Kenney are candidates only, not approved runtime assets.
...
- cover route, threat line, and combat receipt proof is the minimum proof shape for this set.
