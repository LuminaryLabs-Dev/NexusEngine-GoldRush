# Prospector Character Animation - Format Integrity Research
...
Research the source, player-value, and implementation risks for format integrity in the Prospector Character Animation candidate set.
...
This candidate set addresses: current rig is too prototype-like for AAA player feel. The atom matters because confirm the candidate format can enter a browser Three.js pipeline without unsafe conversion surprises.
