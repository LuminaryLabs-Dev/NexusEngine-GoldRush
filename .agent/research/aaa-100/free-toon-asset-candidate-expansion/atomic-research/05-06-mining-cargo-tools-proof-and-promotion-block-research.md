# Mining Cargo Tools - Proof And Promotion Block Research
...
Research the source, player-value, and implementation risks for proof and promotion block in the Mining Cargo Tools candidate set.
...
This candidate set addresses: mine, carry, and cashout actions lack tactile object identity. The atom matters because define local/public proof and keep runtime promotion blocked until approval records exist.
