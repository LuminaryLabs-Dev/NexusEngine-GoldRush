# Mining Cargo Tools - Toon Style Adaptation Research
...
Research the source, player-value, and implementation risks for toon style adaptation in the Mining Cargo Tools candidate set.
...
This candidate set addresses: mine, carry, and cashout actions lack tactile object identity. The atom matters because define how the asset will match GoldRush toon western palette, scale, silhouette, and material roles.
