# Frontier Town And Camp Props - Format Integrity Research
...
Research the source, player-value, and implementation risks for format integrity in the Frontier Town And Camp Props candidate set.
...
This candidate set addresses: POIs lack readable western identity. The atom matters because confirm the candidate format can enter a browser Three.js pipeline without unsafe conversion surprises.
