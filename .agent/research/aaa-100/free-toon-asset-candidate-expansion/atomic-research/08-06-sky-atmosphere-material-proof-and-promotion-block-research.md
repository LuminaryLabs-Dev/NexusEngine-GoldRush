# Sky Atmosphere Material - Proof And Promotion Block Research
...
Research the source, player-value, and implementation risks for proof and promotion block in the Sky Atmosphere Material candidate set.
...
This candidate set addresses: terrain and horizon need a coherent toon mood. The atom matters because define local/public proof and keep runtime promotion blocked until approval records exist.
