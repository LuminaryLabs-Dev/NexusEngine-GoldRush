# Frontier Town And Camp Props - Toon Style Adaptation Research
...
Research the source, player-value, and implementation risks for toon style adaptation in the Frontier Town And Camp Props candidate set.
...
This candidate set addresses: POIs lack readable western identity. The atom matters because define how the asset will match GoldRush toon western palette, scale, silhouette, and material roles.
