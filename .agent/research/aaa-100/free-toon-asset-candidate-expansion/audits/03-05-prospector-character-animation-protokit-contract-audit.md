# Prospector Character Animation - Protokit Contract Audit
...
Harden protokit contract for the Prospector Character Animation candidate set so free asset work moves GoldRush toward AAA toon western quality without unsafe imports or renderer-owned content.
...
Do not implement protokit contract as a broad asset pass. Treat it as one gate for one candidate family. The next state should be a small evidence-backed candidate record and proof plan, not runtime content.
