# Combat Cover Weapon Cues - Format Integrity Audit
...
Harden format integrity for the Combat Cover Weapon Cues candidate set so free asset work moves GoldRush toward AAA toon western quality without unsafe imports or renderer-owned content.
