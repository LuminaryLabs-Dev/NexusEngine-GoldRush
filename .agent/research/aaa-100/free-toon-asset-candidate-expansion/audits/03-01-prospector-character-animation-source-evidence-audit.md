# Prospector Character Animation - Source Evidence Audit
...
Harden source evidence for the Prospector Character Animation candidate set so free asset work moves GoldRush toward AAA toon western quality without unsafe imports or renderer-owned content.
...
Do not implement source evidence as a broad asset pass. Treat it as one gate for one candidate family. The next state should be a small evidence-backed candidate record and proof plan, not runtime content.
