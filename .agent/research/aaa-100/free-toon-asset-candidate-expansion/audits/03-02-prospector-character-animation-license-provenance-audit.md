# Prospector Character Animation - License Provenance Audit
...
Harden license provenance for the Prospector Character Animation candidate set so free asset work moves GoldRush toward AAA toon western quality without unsafe imports or renderer-owned content.
...
Do not implement license provenance as a broad asset pass. Treat it as one gate for one candidate family. The next state should be a small evidence-backed candidate record and proof plan, not runtime content.
