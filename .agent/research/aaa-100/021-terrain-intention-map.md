...
## Question
What has to be researched, specified, and proven so terrain intention map can move GoldRush toward a 60-player high-fidelity wild-west extraction battle royale without breaking the kit-first architecture?
...
Map supports extraction and combat
...
- Folder: .agent/research/aaa-100/021-terrain-intention-map/
- Index: .agent/research/aaa-100/021-terrain-intention-map/README.md
