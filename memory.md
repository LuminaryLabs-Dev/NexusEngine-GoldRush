...
- Latest GoldRush ProtoKit bridge proof is `node tools/validation/validate-goldrush-protokit-bridge.mjs`; it validates four imported ProtoKits, five descriptors, gold pickup, mine checkpoint completion, ambush pressure adjustment, gold delivery, and one main GoldRush runtime tick with the bridge installed.
